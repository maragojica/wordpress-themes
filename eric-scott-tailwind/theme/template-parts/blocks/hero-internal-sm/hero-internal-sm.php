...
<section class="hero-internal-small-section max-w-full h-[20em] lg:h-[25em] xl:h-[600px] relative bg-cover bg-fixed bg-center bg-no-repeat <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?> <?php if(!empty($image)):?>style="background-image: url(<?php echo esc_url($image['url']); ?>)"<?php endif; ?>>
    <?php if($banner_type['value'] == "video"){ 
            ...
            <?php } ?>              
    <div class="overlay <?php echo esc_attr($container_classes); ?> absolute z-[2] top-0 left-0 <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php if( $bg_overlay): ?> style="background-color: <?php echo $bg_overlay;?>"<?php endif;?> >
     <div class="container mx-auto"> 
        <?php if ($heading) : ?>
           ...
           <?php endif; ?>  
           <?php if($description): ?>
                <div class="text-sub text-white mt-[1.5em] style-disc lg:max-w-[55%] xl:max-w-[50%] animate__animated" data-animation="fadeIn" data-duration="1.3s" >                 
