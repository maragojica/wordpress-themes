<?php
$content_block = get_field('content_block_cta_sm');
if ($content_block) {
...
<section class="cta-banner-sm-section max-w-full h-auto relative bg-cover bg-left lg:bg-center bg-no-repeat <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?> <?php if(!empty($image)):?>style="background-image: url(<?php echo esc_url($image['url']); ?>)"<?php endif; ?>>
       ...
       <div class="<?php echo esc_attr($container_classes); ?> gap-y-[1em] lg:gap-y-0 lg:gap-x-[2em]">
          <div class="<?php echo esc_attr($heading_width); ?> animate__animated" data-animation="fadeIn" data-duration="1.5s">
                ...
                <div class="relative w-fit">
                    <?php if( $subheading): ?>
                        <div class="text-white subheading font-secondary capitalize rotate--10.166 absolute -left-[1.2rem] md:-left-[34px] lg:-left-[51px] -top-[12px] xl:top-0 z-[1] animate__animated" data-animation="fadeIn" data-duration="1.3s"><?php echo $subheading; ?></div>
                    <?php endif; ?>
                    <h2 class="sm text-white w-fit animate__animated" data-animation="fadeIn" data-duration="1.2s">
                        <?php echo $heading; ?>
                    </h2>
                </div>               
                <?php endif; ?> 
                    <?php if($description_one): ?>
                    <div class="text-white <?php if ($heading) : ?> mt-[1.5em] <?php endif; ?> style-disc animate__animated" data-animation="fadeIn" data-duration="1.5s" >                 
            ...
            <div class="<?php echo esc_attr($content_width); ?> animate__animated text-white style-disc animate__animated" data-animation="fadeIn" data-duration="1.5s" >                 
