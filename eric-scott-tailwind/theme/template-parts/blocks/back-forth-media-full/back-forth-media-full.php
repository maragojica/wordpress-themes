...
<section class="back-foth-media-full-section max-w-full relative <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?>>   
    <div class="w-full mx-auto bg-tertiary <?php if($reverse_desktop){ echo " pr-contain not-rp";}else{ echo " pl-contain not-lp";} ?>">     
       <div class="<?php echo esc_attr($container_classes); ?> md:gap-y-0 gap-y-[3em] <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>">
          <div class="<?php echo esc_attr($heading_width); ?> px-[1.5rem] <?php if($reverse_desktop){ ?> md:pl-[80px] <?php }else{ ?> md:pr-[80px] <?php } ?> flex flex-col justify-center animate__animated" data-animation="fadeIn" data-duration="1.5s">
            <?php if ($heading) : ?>
                <div class="relative">
                    <?php if( $subheading): ?>
                        <div class="text-secondary subheading font-secondary capitalize rotate--10.166 absolute -left-[1.2rem] lg:-left-[20px] -top-[14px] xl:top-0 z-[1] animate__animated" data-animation="fadeIn" data-duration="1.3s"><?php echo $subheading; ?></div>
                    <?php endif; ?>
                ...
                <?php endif; ?> 
                <?php if($description): ?>
                    <div class="text-white mt-[1.5em] style-disc animate__animated" data-animation="fadeIn" data-duration="1.5s" >                 
