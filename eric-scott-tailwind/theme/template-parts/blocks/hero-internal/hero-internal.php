...
<section class="hero-internal-section max-w-full h-[33em] lg:h-[28em] xl:h-[900px] relative bg-cover bg-center bg-no-repeat <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?> <?php if(!empty($image)):?>style="background-image: url(<?php echo esc_url($image['url']); ?>)"<?php endif; ?>>
