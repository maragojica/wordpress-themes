...
if (have_rows('info_text_image')) :

    // Loop through the rows of data
    while (have_rows('info_text_image')) : the_row();
        ...
        if (have_rows('content_row_info')) :
            ...
            while (have_rows('content_row_info')) : the_row();
                ...
                <section class="section-info-text-image back-and-forth-row <?php echo ($image_position['value'] == "right") ? 'reverse' : 'normal'; ?>">
                    <div class="container-fluid content-back-forth">
                    <div class="row middle-xs row-back-forth <?php echo ($image_position['value'] == "right") ? 'reverse' : ''; ?>">
