    ...
    <div class="col-lg-7">
        <?php if($cta):
            ...
            <div class="box-cta-btn d-flex align-items-center">
                <a class="cta-btn d-flex align-items-center cl-dark-ocean cl-dark-ocean-h bg-white bg-sky-blue-h border-dark-ocean" aria-label="<?php echo $link_title; ?>" href="<?php echo $link_url; ?>" target="<?php echo $link_target;?>">
                    <?php echo $link_title; ?>
