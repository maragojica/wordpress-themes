...
<header id="masthead" class="site-header main-navigation wow fadeIn" data-wow-duration="0.4s" data-wow-delay="0.2s">
						...
						if ($logo_url) {
							if ($logo_mime_type == 'image/svg+xml') {
								...
								<a tabindex="0" href="<?php echo esc_url(home_url('/')); ?>" rel="home" aria-label="<?php echo get_bloginfo('name'); ?> Logo" title="<?php echo get_bloginfo('name'); ?> Logo">
									<img class="logo" src="<?php echo esc_url($logo_url); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?> Logo" width="280" height="21"/>
								</a>
							<?php }
						}
					} ?>
					...
					if ($logo_url) {
						if ($logo_mime_type == 'image/svg+xml') {
							...
							<a class="flex" tabindex="0" href="<?php echo esc_url(home_url('/')); ?>" rel="home" aria-label="<?php echo get_bloginfo('name'); ?> Logo" title="<?php echo get_bloginfo('name'); ?> Logo">
								<img class="skip-lazy" src="<?php echo esc_url($logo_url); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?> Logo" width="180" height="20"/>
							</a>
						<?php }
					}
				} ?>
