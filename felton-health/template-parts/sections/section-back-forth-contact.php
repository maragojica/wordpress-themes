<?php       
if (have_rows('back_forth_contact')) :          
    while (have_rows('back_forth_contact')) : the_row();
        ...
        <section <?php if($section_id): ?> id="<?php echo $section_id;?>" <?php endif;?> <?php if($section_bg_color): ?>style="background-color: <?php echo $section_bg_color; ?>"<?php endif; ?> class="section-back-forth-contain <?php if($padding_size): echo $padding_size['value']; endif; ?> <?php if(!$padding_top_desktop): echo ' p-lg-t0'; endif; if(!$padding_bottom_desktop): echo ' p-lg-b0'; endif; if(!$padding_top_mobile): echo ' p-mv-t0'; endif; if(!$padding_bottom_mobile): echo ' p-mv-b0'; endif; ?>">
            <div class="container">
            <div class="row middle-xs <?php if($form_position['value'] == "right"){ echo ' reverse'; if($reverse_mobile){ echo ' columnr-reverse-mv'; } }else{ echo ' normal'; if($reverse_mobile){ echo ' columnr-reverse-mv'; } } ?>">      
                 <div class="col-img col-xs-12 col-lg-6 mb-lg-0 mt-lg-0">                    
                    <?php if ( $gravity_form_shortcode ): ?>                           
                        <div class="box-contact-form bg-cream <?php echo ($form_position['value'] == "right") ? ' fadeInRight' : ' fadeInLeft'; ?>" data-wow-duration="0.7s" data-wow-delay="0.2s"><?php echo $gravity_form_shortcode; ?></div>
                    <?php endif; ?>  
                  </div>               
                    <div class="col-info col-xs-12 col-lg-6 <?php echo ($form_position['value'] == "right") ? 'pe-lg-4' : 'ps-lg-4'; ?>">                      
                                <?php if ($subheadline) : ?>
