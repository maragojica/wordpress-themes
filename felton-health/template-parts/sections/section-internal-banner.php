...
if (have_rows('internal_banner')) {
    ...
    <section <?php if($section_id): ?> id="<?php echo $section_id;?>" <?php endif; ?> class="page-internal-hero py-0 flex w-margin <?php if($margin_size): echo $margin_size['value']; endif; ?> <?php if(!$margin_top_desktop): echo ' mt-0'; endif; if(!$margin_bottom_desktop): echo ' mb-0'; endif; if(!$margin_top_mobile): echo ' m-mv-t0'; endif; if(!$margin_bottom_mobile): echo ' m-mv-b0'; endif; ?>" <?php if($banner_type['value'] == "image" && !empty($banner_image)): ?>style="background: url(<?php echo esc_url($banner_image['url']); ?>)"<?php endif; ?>>            
                ...
                <div class="container">
                    <div class="row middle-xs center-xs">
                        <div class="col-xs-12 col-lg-9 col-xl-8 text-center">                        
                            <?php if ($headline) : ?>
                                <h1 class="cl-white head-md text-uppercase m-t0 mb-0 wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.2s"><?php echo $headline; ?></h1>
                            <?php endif; ?>
                            <?php if ($subheadline) : ?>
                                    <div class="subheadline cl-white pt-17px pb-17px text-uppercase wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.2s"><?php echo $subheadline; ?></div>
                                <?php endif; ?>   
                            <?php if ($description) : ?>
