<?php
$content_block = get_field('testimonials_slider');
if ($content_block) {
...
<section class="partner-slider-section max-w-full relative overflow-hidden lg:h-fit <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>  <?php if($bg_color):?> style="background-color: <?php echo $bg_color;?>" <?php endif; ?>>
    ...
    <div class="<?php echo esc_attr($container_classes); ?> gap-y-[2em] lg:gap-y-0 lg:gap-x-[2em] xl:gap-x-[3em] 2xl:gap-x-[144px]">
       <div class="w-full lg:w-2/5 2xl:w-1/2 animate__animated lg:pr-0 pr-[2em]" data-animation="fadeIn" data-duration="1.5s">                
           <?php if ($subheading) : ?>
        ...
        <div class="w-full lg:w-3/5 2xl:w-1/2 animate__animated" data-animation="fadeIn" data-duration="1.5s"> 
        <?php if ($slider):  ?>  
            <div class="slider-testimonials slider-fluid-full owl-carousel owl-theme relative overflow-hidden">
            <?php foreach ($slider as $column_slider): 
                   $image = $column_slider['image']; 
                   $text = $column_slider['text'];
                   $name = $column_slider['name'];?>
                   <div class="testimonials-slide h-full fluid-slide item">
                   <div class="flex flex-col h-full">                           
                         <?php  echo wp_get_attachment_image(
                            ...
                            false,
                            array(
                                'class' => 'transition-all duration-300 w-full h-[10em] sm:h-[15em] md:h-[30em] lg:h-[15em] xl:h-[280px] 2xl:h-[396px] 3xl:h-[450px] object-cover object-center',
                            ...
                            <div class="flex flex-grow justify-start flex-wrap flex-col p-[20px] lg:px-[40px] lg:py-[30px] bg-primary">                                 
                                ...
                                <?php endif; ?> 
                                <?php if($name): ?>
                                     <div class="font-text-font text-white italic m-2 text-[16px] lg:text-[20px] text-left">—<?php echo $name;?></div>   
                                <?php endif; ?>
                            </div>                                       
