                ...
                <div class="container h-100 flex flex-column center-xs center-xs text-center">
                    <div class="row center-xs">
                       <div class="col-xs-12"> 
                            ...
                            <img class="img-logo-banner img-fluid wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s" src="<?php echo esc_url($logo['url']); ?>" alt="<?php echo esc_attr($logo['alt']); ?>" height="203" width="500"/>                            
                        <?php endif; ?>  
                           <?php if($headline): ?>
                                <h1 class="cl-white text-uppercase mt-0 mb-02 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"><?php echo $headline; ?></h1>
                           <?php endif; ?>   
                           <?php if($description): ?>
                               <div class="dp-2 text-caps m-b2 cl-white wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s"><?php echo $description; ?></div>
                            <?php endif; ?> 
                           <?php if( $cta ):
                            $link_url = $cta['url'];
                            $link_title = $cta['title'];
                            $link_target = $cta['target'] ? $cta['target'] : '_self'; ?>     
                              <div class="mt-lg-0 m-t1 box-link-banner">                        
