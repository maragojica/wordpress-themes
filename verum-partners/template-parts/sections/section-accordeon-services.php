<?php 
if (have_rows('content_services')) :          
    while (have_rows('content_services')) : the_row();
    $section_id = get_sub_field('section_id');
    $section_headline = get_sub_field('heading'); 
    $padding_top_desktop = get_sub_field('padding_top_desktop'); 
    $padding_bottom_desktop = get_sub_field('padding_bottom_desktop');      
    $padding_top_mobile = get_sub_field('padding_top_mobile'); 
    $padding_bottom_mobile = get_sub_field('padding_bottom_mobile');  ?>
<section <?php if($section_id): ?> id="<?php echo $section_id;?>" <?php endif;?> class="section-accordeon section-accordeon-services <?php if(!$padding_top_desktop): echo ' p-t0'; endif; if(!$padding_bottom_desktop): echo ' p-b0'; endif; if(!$padding_top_mobile): echo ' p-mv-t0'; endif; if(!$padding_bottom_mobile): echo ' p-mv-b0'; endif; ?>">            
    <div class="container">    
        ...
        <div class="row justify-center">
            ...
            <?php if ( have_rows( 'list_services' ) ):  ?>
                ...
                <?php while( have_rows('list_services') ): the_row(); 
                  ...
                  <?php if($title): ?>
                    <button class="accordion cl-white" title="Accordeon" <?php if($service_id): ?> id="<?php echo $service_id;?>" <?php endif; ?>><?php echo $title; ?></button>
                  <?php endif; ?>
                  <div class="panel">
                  <?php if ($text) : ?>
