...
<div class="progress-wrap">
	...
	<header id="masthead" class="site-header header-bg main-navigation">
	<div class="container">
							...
							if ($logo_url) {
								if ($logo_mime_type == 'image/svg+xml') {
									...
									<a tabindex="0" href="<?php echo esc_url(home_url('/')); ?>" rel="home" aria-label="<?php echo get_bloginfo('name'); ?> Logo" title="<?php echo get_bloginfo('name'); ?> Logo">
										<img class="logo" src="<?php echo esc_url($logo_url); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?> Logo" width="192" height="78"/>
									</a>
								<?php }
							}
						} ?>
