...
?>
	...
	<footer id="colophon" class="site-footer wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.3s">
		<div class="container">
			<div class="row">
		...
		if (have_rows('footer_copyright', 'option')) {
			while (have_rows('footer_copyright', 'option')) {
				...
				<div class="row middle-xs">
					<div class="col-xs-12 text-center">
						<div class="copyright-info"><p>&#169; Copyright <?php echo date_i18n( 'Y' ).' '.get_sub_field('made_with_love', 'option'); ?></p></div>						
					</div>	
				</div>
