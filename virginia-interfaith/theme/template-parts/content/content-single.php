...
<div class="single-content pt-[121px] xl:pt-[158px]">
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<section class="content-section max-w-full relative bg-accent   padding-large"> 
		...
		<div class="flex flex-col ">
			<div class="w-full"> 
				...
				<div class="eyebrow text-secondary mb-[20px]">
					...
					<?php if ( $display_date && $category_label ) : ?>  |  <?php endif; ?>
