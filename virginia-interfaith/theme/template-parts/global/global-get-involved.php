<?php
$content_block = get_field('content_block_get_involved', 'option');
if ($content_block) {   
...
<section <?php if($section_id) echo 'id="' . esc_attr($section_id) . '"'; ?> class="get-involved-section bg-white max-w-full w-full relative overflow-hidden">
