<?php
$content_block = get_field('content_block_info_contact');
if ($content_block) {   
   
    $subheading = $content_block['subheading']; 
    $heading = $content_block['heading'];     
    $description = $content_block['description']; 
    $contact = $content_block['contact']; 
...
<section class="info-contact-section max-w-full relative bg-accent overflow-hidden <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>   
    <div class="container mx-auto relative z-2">        
          <div class="w-full lg:max-w-[90%] xl:max-w-[80%] mx-auto <?php echo esc_attr($container_classes); ?> relative lg:gap-y-0 gap-y-[2em]">  
                <div class="w-full lg:w-1/2  custom-p-info">             
                <?php if($subheading): ?>
                ...
                <?php endif; ?>  
                <?php if($description): ?>
                        <div class="text-foreground text-smallstyle-disc mt-[15px]" data-aos="fade-up" data-aos-delay="100" >                 
                            <?php echo $description; ?>                   
                        </div>
                    <?php endif; ?>  
                </div>
                <div class="w-full lg:w-1/2">
                     <div class="relative bg-white border-[4px] border-primary pt-[40px] pb-[46px] px-[60px] lg:max-w-[80%] mx-auto">
                         <?php if($contact): ?>
                        <div class="text-foreground text-smallstyle-disc mt-[5px] text-center" data-aos="fade-in" data-aos-delay="100" >                 
                            <?php echo $contact; ?>                   
                        </div>
                    <?php endif; ?>  
                    <?php if ($buttons) : ?>
                        <div class="flex flex-wrap gap-2 lg:gap-[16px] justify-center absolute bottom-[-24px] left-0 right-0" data-aos="fade-up">
