...
if ($content_block) {    
    ...
    $resources = $content_block['resources'];
...
<section class="resources-section max-w-full relative overflow-hidden <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
    ...
    <div class="container mx-auto relative z-[2]">
        ...
        <!-- Resources Grid -->
        <?php if ($resources) : ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 md:gap-x-[40px] gap-y-8 lg:gap-y-[40px] grid-resources" data-aos="fade-up">
               <?php foreach ($resources as $column): 
                   $title = $column['title'];
                   $text = $column['text'];
                   $buttons_cta = $column['buttons_cta'];
                ?>
                ...
                <div class="event-card flex flex-col h-full justify-between align-items-center">  
                    <div class="event-conten bg-accent group pt-[35px] lg:pt-[37px] px-[35px] pb-[35px] lg:pb-[40px] flex flex-col flex-grow rounded-[20px]">  
                        <div class="resource-title flex-grow">
                         ...
                         <!-- CTA Resources -->
                        <?php if ($buttons_cta) : ?>
                        <div class="flex flex-wrap gap-2 lg:gap-[16px] mt-[20px] justify-center" data-aos="fade-up">
