...
<section class="all-events-section max-w-full relative overflow-hidden <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-10 lg:gap-x-12 gap-y-8 lg:gap-y-[80px]" data-aos="fade-up">
                ...
                <div class="event-card <?php if( $count_allpost > 6): ?> event-item <?php endif; ?>">
                    ...
                    <div class="event-content group">
                        <div class="event-date eyebrow text-secondary">
                             <?php echo $start_date; ?>
                        </div>
                        ...
                        <?php if ($short_description != '') : ?>
                            <div class="text-small event-description text-foreground mt-[10px]">
