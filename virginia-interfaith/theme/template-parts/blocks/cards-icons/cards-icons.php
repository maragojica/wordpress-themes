...
if ($content_block) {
    ...
    $gap_class = 'gap-y-[63px]'; // Default vertical gap
    switch ($columns_gap) {
        case 'small':
            $gap_class .= ' md:gap-x-[15px] xl:gap-x-[22px]';
            break;
        case 'medium':
            $gap_class .= ' md:gap-x-[25px] xl:gap-x-[40px]';
            break;
        case 'large':
            $gap_class .= ' md:gap-x-[35px] xl:gap-x-[93px]';
            break;       
        default:
            $gap_class .= ' md:gap-x-[25px] xl:gap-x-[40px]';
            break;
      ...
      <div class="container mx-auto"> 
          <div class="<?php echo esc_attr($container_classes); ?>">
              <div class="w-full lg:w-[70%]">
                   <?php if($subheading): ?>
                        <div class="eyebrow text-primary mb-[12px]" data-aos="fade-up">
                            <?php echo $subheading; ?>
                        </div>  
                    <?php endif; ?> 
                        <?php if ($heading) : ?>
                        <h2 class="<?php echo esc_attr($text_color_class); ?> heading-shape mb-0" data-aos="fade-up" >
                            <?php echo $heading; ?>
                        </h2> 
                    <?php endif; ?>                        
                        <?php if($description): ?>
                        <div class="<?php echo esc_attr($text_color_class); ?> style-disc mt-[15px]" data-aos="fade-up" data-aos-delay="100" >                 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-<?php echo $num_cols; ?> <?php echo esc_attr($gap_class); ?> mt-[46px]">
                 <?php $i = 0; foreach ($info_list as $column): 
                    ...
                    <div class="relative" data-aos="fade-up" data-aos-delay="<?= $i * 100 ?>">  
                      <div class="h-full flex flex-col bg-accent rounded-[20px] px-[20px] lg:px-[25px] pt-[25px] lg:pt-[32px] pb-[50px] items-center text-center relative">
                         <?php if ($icon) :
                          $icon_url = $icon['url'];
                            $icon_alt = $icon['alt']; ?>    
                            <div class="w-[60px] h-[60px] lg:w-[88px] lg:h-[88px] flex items-center justify-center mx-auto">                         
                                <img class="object-contain w-[60px] h-[60px] lg:w-[88px] lg:h-[88px]" src="<?php echo esc_url($icon_url); ?>" alt="<?php echo esc_attr($icon_alt); ?>" title="<?php echo esc_attr($icon_alt); ?>">
                            </div>
                        <?php endif; ?>                                 
                        <?php if ($title) : ?>
                            <h3 class="text-foreground mt-[20px] mb-0">
                                <?php echo $title; ?>
                            </h3>
                        <?php endif; ?>
                        <?php if ($text) : ?>
                        ...
                        <?php endif; ?>   
                        <?php if ($buttons) : ?>                                
                        <div class="flex flex-wrap gap-2 lg:gap-8 absolute bottom-[-24px] left-0 right-0 justify-center">
                  ...
                  <?php if(!empty($image)): ?>
                    <div class="relative" data-aos="fade-in"> 
                        <div class="lg:h-full md:h-[30em] sm:h-[25em] h-[20em] bg-accent rounded-[20px] bg-cover bg-top bg-no-repeat" style="background-image: url('<?php echo esc_url($image['url']); ?>');"></div>
                    </div>
                   <?php endif; ?> 
             </div>     
         </div>   
