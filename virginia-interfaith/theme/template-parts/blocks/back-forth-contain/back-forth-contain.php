...
<section class="back-forth-contain-section max-w-full relative <?php if($add_media_top_overlap || $add_media_bottom_overlap){ echo ' overflow-y-visible';  }else{ echo ' overflow-hidden';} ?> <?php if($bg_color): echo $bg_class; endif; ?> <?php if($add_media_top_overlap): echo ' lg:mt-[60px]'; endif; ?> <?php if($add_media_bottom_overlap): echo ' lg:mb-[60px]'; endif; ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>   
          ...
          <div class="<?php echo esc_attr($container_classes); ?> lg:gap-y-0 gap-y-[3em]">               
              <div class="<?php echo esc_attr($heading_width); ?> custom-p-info <?php echo $row_gap_class; ?> <?php echo $columns_gap_class; ?>  justify-center">
                ...
                <div class="<?php echo esc_attr($content_width); ?>" data-aos="fade-left" >  
                   <div class="lg:block hidden w-full lg:h-full relative circle-mask <?php if($add_media_top_overlap){ echo ' lg:-mt-[60px]'; } ?> <?php if($add_media_bottom_overlap){ echo ' lg:-mb-[60px]'; } ?>">       
                        <div class="circle-container">
                            <div class="circle-mask-wrapper">
                                <?php if(!empty($image)){ ?>
                     ...
                     <div class="lg:hidden block w-[calc(100%_+_3rem)] ml-[-1.5rem] lg:h-full md:h-[30em] sm:h-[25em] h-[20em] relative bg-cover bg-top bg-no-repeat" <?php if(!empty($image)){ ?> style="background-image: url('<?php echo esc_url($image['url']); ?>');" <?php } ?>>
