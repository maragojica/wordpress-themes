...
$content_block = get_field('content_block_upcoming_events');
if ($content_block) {
...
<section class="upcoming-events-section max-w-full relative overflow-hidden <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
