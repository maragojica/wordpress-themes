...
if ($content_block) {
    ...
    $add_quick_links = $content_block['add_quick_links'];   
    $quick_links_title = $content_block['quick_links_title'];
    $quick_links = $content_block['quick_links'];
     $add_media_top_overlap = $content_block['add_media_top_overlap']; 
    $add_media_bottom_overlap = $content_block['add_media_bottom_overlap'];    
    $add_counters = $content_block['add_counters'];
...
<section class="back-foth-media-full-section max-w-full relative <?php if($add_media_top_overlap || $add_media_bottom_overlap){ echo ' overflow-y-visible';  }else{ echo ' overflow-hidden';} ?> <?php if($bg_color): echo $bg_class; endif; ?>  <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>   
    
     <?php if($add_bottom_wave){ ?>
        <div class="absolute right-0 z-1 bottom-0 w-[100%] lg:block hidden" data-aos="fade-in">
             <?php 
    ...
    <?php } ?>   
        <div class="w-full mx-auto <?php if($reverse_desktop){ echo " pr-contain not-rp";}else{ echo " pl-contain not-lp";} ?> relative z-2">        
          <div class="<?php echo esc_attr($container_classes); ?> lg:gap-y-0 gap-y-[3em]">               
              <div class="<?php echo esc_attr($heading_width); ?> px-[2rem] custom-p-info <?php echo $row_gap_class; ?> <?php echo $columns_gap_class; ?>  justify-center">
                    ...
                    <?php endif; ?>    
                    <?php if($add_counters && $counters): ?>
                        <div class="flex flex-col sm:gap-y-0 gap-y-[1em] sm:flex-row flex-wrap justify-between items-center lg:items-start mx-auto w-full lg:gap-x-[59px]">  
                            <?php foreach ($counters as $column) : 
                                 $title = $column['text_number'];
                             ...
                             <div class="mt-[30px]" data-aos="fade-up" >
                                <div class="flex flex-col h-full relative justify-between items-center text-center">  
                                    <div class="flex-wrap flex justify-center items-center flex-col">
                                        <?php if($number): ?>
                                            <div class="flex items-center gap-[4px] box-counters uppercase"><div class="text-action mb-0 counter-number"  data-count="<?php echo esc_attr($number); ?>">0</div></div>
                                        <?php endif; ?>
                                        <?php if($title): ?>
                                            <h5 class="text-foreground text-sub"><?php echo $title; ?></h5>
                                        <?php endif; ?>                              
                                    </div>                      
                                </div>
                            </div>
                    ...
                    <?php if ($buttons) : ?>
                        ...
                        <?php endif; ?>  
                        <?php if($add_quick_links && $quick_links): ?>
                               <?php if($quick_links_title): ?>
                                    <h3 class="mt-[30px] xl:mt-[40px] mb-0 <?php echo esc_attr($text_color_class); ?>" data-aos="fade-up"><?php echo esc_html($quick_links_title); ?></h3>
                                <?php endif; ?>
                               <div class="flex flex-wrap gap-2 lg:gap-[16px] mt-[20px] justify-start" data-aos="fade-up">
                            <?php foreach ($quick_links as $button) : ?>
                                <?php 
                                $button_link = $button['button'];
                                $button_style = $button['button_style'];
                                $is_external = $button['is_external'];
                ...
                <div class="<?php echo esc_attr($content_width); ?>" data-aos="fade-left" >  
                   <div class="lg:block hidden w-full lg:h-full relative <?php if($reverse_desktop){ ?> elipse-left <?php }else{ ?> elipse-right <?php } ?> <?php if($add_media_top_overlap){ echo ' lg:-mt-[80px]'; } ?> <?php if($add_media_bottom_overlap){ echo ' lg:-mb-[80px]'; } ?>">       
