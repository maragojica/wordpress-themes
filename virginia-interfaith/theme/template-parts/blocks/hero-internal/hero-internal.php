<?php
$content_block = get_field('content_block_hero_internal');
if ($content_block) {
    ...
    $text_align = $content_block['text_align'];
    ...
    $container_classes = ' flex flex-col lg:flex-row items-center ';   
    ...
    if($add_bottom_wave){
     ...
     $container_content_classes = ' lg:pb-0';
    if($add_bottom_wave){   
    switch ($wave_color) {
        case 'neutral':                
            $container_content_classes .= ' lg:pb-[100px] ';
            break;
        case 'dark-blue':               
            $container_content_classes .= ' lg:pb-[36px] ';
            break;
        case 'blue-swish':              
            $container_content_classes .= ' lg:pb-[100px] ';
            break;
...
<section class="internal-hero-section max-w-full relative <?php if($wave_color == 'dark-blue' || $wave_color == 'blue-swish'){ echo ' overflow-y-visible';  }else{ echo ' overflow-hidden';} ?> <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>   
    
     <?php if($add_bottom_wave){ ?>
        <div class="absolute right-0 z-1 w-[100%] lg:block hidden wave-bottom <?php echo $wave_color; ?> <?php if($wave_color == 'dark-blue'){ echo 'bottom-[-36px]'; }else echo 'bottom-[-2px]'; ?>" data-aos="fade-in">
             <?php 
    ...
    <?php } ?>   
        <div class="container mx-auto relative z-2 <?php echo esc_attr($container_content_classes); ?>">        
          <div class="<?php echo esc_attr($container_classes); ?> lg:gap-y-0 gap-y-[3em]">               
              <div class="w-full lg:px-[2rem] <?php echo esc_attr($text_align_class); ?>">
                   <?php if($add_breadcrumbs && $breadcrumbs): ?>
                    <div class="breadcrumbs mb-[20px]">
                        <?php 
                ...
                <?php endif; ?>
                    ...
                    <?php endif;  endif; ?>                     
                        <?php if($description): ?>
                        <div class="<?php echo esc_attr($text_color_class); ?> style-disc mt-[20px]" data-aos="fade-in" >                 
