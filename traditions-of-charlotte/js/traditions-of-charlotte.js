...
# Projects Load More
--------------------------------------------------------------*/
jQuery('.row-projects-projects-two').simpleLoadMore({
  item: '.col-projects-two',
  count: 4,
  itemsToLoad: 2,
  btnHTML: '<div class="col-xs-12 center-xs m-t3"><a href="#" tab-index="0" aria-label="Load More" title="Load More" class="load-more__btn btn btn-forest-green hover-slide-right"><span class="text">Load More</span></a></div>'
});

jQuery('.row-projects-projects-three').simpleLoadMore({
  item: '.col-projects-three',
  count: 6,
  itemsToLoad: 3,
  btnHTML: '<div class="col-xs-12 center-xs m-t3"><a href="#" tab-index="0" aria-label="Load More" title="Load More" class="load-more__btn btn btn-forest-green hover-slide-right"><span class="text">Load More</span></a></div>'
});
