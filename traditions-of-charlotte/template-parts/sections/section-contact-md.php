...
if (have_rows('contact')) :          
    while (have_rows('contact')) : the_row();
        ...
        <section <?php if($section_id): ?> id="<?php echo $section_id;?>" <?php endif;?> class="section-contact md w-margin p-t0 p-b0 <?php if(!$margin_top_desktop): echo ' m-t0'; endif; if(!$margin_bottom_desktop): echo ' m-b0'; endif; if(!$margin_top_mobile): echo ' m-mv-t0'; endif; if(!$margin_bottom_mobile): echo ' m-mv-b0'; endif; ?>" <?php if($bg_color){ ?>style="background-color: <?php echo $bg_color;?>"<?php } ?>>
            <div class="container-fluid w-100 pe-lg-0 ps-lg-0">
            <div class="row middle-xs <?php if($media_position['value'] == "right"){ echo ' reverse'; if($reverse_mobile){ echo ' columnr-reverse-mv'; } }else{ echo ' normal'; if($reverse_mobile){ echo ' columnr-reverse-mv'; } } ?>">      
            <div class="col-img col-xs-12 col-lg-6 mb-lg-0 mt-lg-0 pe-lg-0 ps-lg-0">
                    <div class="media-back-forth wow <?php echo ($media_position['value'] == "right") ? ' fadeInRight' : ' fadeInLeft'; ?>" data-wow-duration="0.8s" data-wow-delay="0.2s">
                    ...
                    <div class="col-xs-12 col-lg-6 <?php echo ($media_position['value'] == "right") ? 'pe-lg-6 ps-contain' : 'ps-lg-6 pe-contain'; ?>">   
