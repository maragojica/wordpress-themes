<?php if ( have_rows( 'main_slider' ) ): ?>
    ...
    <section class="section-main-slider p-t0 p-b0" <?php if($section_id): ?> id="<?php echo $section_id;?>" <?php endif;?>>       
            ...
            $video_ogg = get_sub_field('slider_video_ogg'); 
            $video_webm = get_sub_field('slider_video_webm'); 
            $headline = get_sub_field('headline');  
            $subheadline = get_sub_field('subheadline');
            $cta = get_sub_field('button_cta');
            $description = get_sub_field('description'); ?>
                <div class="main-slide">
                    <div class="row me-lg-0 ms-lg-0">
                        <div class="col-xs-12 col-lg-6 pe-lg-0 ps-lg-0">
                            ...
                            <?php if($slider_type['value'] == "image"){ ?>
                                <?php if ( !empty($slider_image)) : 
                                    ...
                                    <img class="no-lazy fit-cover-center img-fluid w-100 h-100 img-main-slide" src="<?php echo esc_url($slider_image['url']); ?>" alt="<?php echo esc_attr($slider_image['alt']); ?>" height="1080" srcset="<?php echo esc_attr($srcset); ?>" sizes="<?php echo esc_attr($sizes); ?>"/>                            
                                <?php endif; ?>   
                        ...
                        <div class="col-xs-12 col-lg-6 pe-lg-0 ps-lg-0 mt-lg-0 m-t3">
