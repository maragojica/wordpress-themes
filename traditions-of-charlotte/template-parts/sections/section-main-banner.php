...
if (have_rows('main_banner')) :          
 ...
 <section <?php if($section_id): ?> id="<?php echo $section_id;?>" <?php endif;?> class="section-main-banner <?php if(!$padding_top_desktop): echo ' p-lg-t0'; endif; if(!$padding_bottom_desktop): echo ' p-lg-b0'; endif; if(!$padding_top_mobile): echo ' p-mv-t0'; endif; if(!$padding_bottom_mobile): echo ' p-mv-b0'; endif; ?>" <?php if($bg_color_section): ?>style="background-color: <?php echo $bg_color_section;?>"<?php endif; ?>>
            ...
            <div class="col-img col-xs-12 col-lg-6 mb-lg-0 mt-lg-0 pe-lg-0 ps-lg-0">
                    <div class="media-slider wow <?php echo ($image_position['value'] == "right") ? ' fadeInRight' : ' fadeInLeft'; ?>" data-wow-duration="0.8s" data-wow-delay="0.2s">
                           <?php if($media_type['value'] == "image"){ ?>
                            <?php if ( !empty($image)) : 
                                    $srcset = wp_get_attachment_image_srcset($image['ID']);
                                    $sizes = wp_get_attachment_image_sizes($image['ID'], 'full'); 
                                    $caption = esc_attr($image['caption']); ?>                
                                <img class="no-lazy img-fluid w-100 h-100 fit-cover-center" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" height="850" srcset="<?php echo esc_attr($srcset); ?>" sizes="<?php echo esc_attr($sizes); ?>"/>                            
                                <?php if($caption): ?>
                  ...
                  <div class="col-xs-12 col-lg-6 <?php echo ($image_position['value'] == "right") ? 'pe-lg-6 ps-contain' : 'ps-lg-6 pe-contain'; ?>">   
                        ...
                        <?php endif; ?>
                        <?php if ($description) : ?>
                            <div class="dp-2 m-b30 cl-forest-green wow fadeInUp" data-wow-duration="0.7s" data-wow-delay="0.2s"><?php echo wp_kses_post($description); ?></div>
                            <?php endif; ?> 
