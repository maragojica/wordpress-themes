    ...
    <section class="section-main-single section-inside bg-white pb-5">
        <div class="container pt-md-5 pb-md-5 pt-4 pb-0">
                ...
                <div class="col-lg-7">
                    <div class="content-cat d-flex align-items-center cl-green">
                            ...
                            foreach((get_the_category()) as $category) {
                                ...
                                <a href="<?php echo $cateslug;?>" class="link-content-cat cl-green" aria-label="<?php echo  $catename;?>">
                               <?php if($i>1){
                                    echo  ' // '. $catename;
                                }else{echo  $catename;  } ?>
                                </a>
            ...
            <div class="row justify-content-center pb-4 mb-md-5">
                <div class="col-lg-7">
                    <div class="back"><a href="/resources" aria-label="Back to resources"><svg class="me-2" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            if($title_box_bottom || $cta_box_bottom): ?>
                <div class="row equal mt-md-5 mt-3">
                    <div class="col-md-12">
                        <div class="w-100 h-100 pt-5 pb-5 bg-accent-grey-1 text-center d-flex flex-column align-items-center justify-content-center position-relative">
                            ...
                            <div class="info-box-botom z-index-2">
                                <?php if($title_box_bottom): ?>
                                    <h6 class="cl-blue pt-md-4"><?php echo $title_box_bottom; ?></h6>
                                <?php endif; ?>
                                <?php if($cta_box_bottom):
                                    ...
                                    <div class="box-cta-btn d-flex align-items-center justify-content-center mt-4 pb-md-4">
