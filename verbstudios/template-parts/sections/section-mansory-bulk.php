        ...
        <div class="row justify-center">
               <?php if ($subheadline || $headline) : ?>
                ...
                <?php $gallery_bulk = get_sub_field('gallery_bulk');
                 if ($gallery_bulk) :                   
                    $pattern = array('tall', 'default', 'default', 'default', 'default', 'default', 'default', 'tall', 'default', 'default');
                    $counter = 0; ?>
                <div class="mansory-wrapper-bulk <?php if($add_load_more): ?> mansory-load-content <?php endif; ?>">
