    ...
    <div class="container">
        <div class="row justify-center">
               <?php if ($subheadline || $headline) : ?>
                ...
                <div class="mansory-wrapper <?php if($add_load_more): ?> mansory-load-content <?php endif; ?>">
                ...
                $sizes = wp_get_attachment_image_sizes($galimage['ID'], 'full'); ?>
                    <div class="<?php if($add_load_more): ?> mansory-load-item <?php endif; ?> <?php echo $galpattern['value']; ?>">
