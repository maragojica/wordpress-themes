    ...
    while (have_rows('back_forth_content')) : the_row();
        ...
        <section <?php if($section_id): ?> id="<?php echo $section_id;?>" <?php endif;?> class="section-back-forth-contain <?php if($padding_size): echo $padding_size['value']; endif; ?> <?php if(!$padding_top_desktop): echo ' p-lg-t0'; endif; if(!$padding_bottom_desktop): echo ' p-lg-b0'; endif; if(!$padding_top_mobile): echo ' p-mv-t0'; endif; if(!$padding_bottom_mobile): echo ' p-mv-b0'; endif; ?>">
            ...
            <div class="col-img col-xs-12 col-lg-6 mb-lg-0 mt-lg-0">
                    <div class="media-content <?php echo $media_size['value']; ?> wow <?php echo ($image_position['value'] == "right") ? ' fadeInRight' : ' fadeInLeft'; ?>" data-wow-duration="0.3s" data-wow-delay="0.2s">
                    ...
                    <div class="col-info col-xs-12 col-lg-6 <?php echo ($image_position['value'] == "right") ? 'pe-lg-4 ps-lg-4' : 'pe-lg-4 ps-lg-4'; ?>">                      
                                <?php if ($subheadline) : ?>
                                    ...
                                    <?php if (have_rows('button_list')) {  ?> 
                                        <div class="button-list-info start-xs mt-20px mt-lg-2 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.2s">  
