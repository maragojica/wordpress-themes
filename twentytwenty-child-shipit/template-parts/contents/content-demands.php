<?php
/**
 * Displays the content when the our demands template is used.
 *
 * @package WordPress
...
<section class="description-inside bg-light-blue pt-md-5 pb-md-4 wow fadeIn" data-wow-duration="1s" data-wow-delay="1s">
...
<section class="description-inside bg-white wow fadeIn" data-wow-duration="1s" data-wow-delay="1s">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8">
