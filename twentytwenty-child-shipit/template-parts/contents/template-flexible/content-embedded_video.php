<section class="module module-block-video <?php if(!get_sub_field('add_padding_video')): ?>pt-0<?php endif;?> wow fadeIn" data-wow-duration="0.2s" data-wow-delay="0.2s">
    <div class="container">
        <?php
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-video position-relative">
                    <?php if($captions): ?><div class="captions-media bg-ultra-violet cl-white"><?php echo $captions;?></div><?php endif; ?>
