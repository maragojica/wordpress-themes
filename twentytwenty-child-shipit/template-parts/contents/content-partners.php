<?php
/**
 * Displays the content when the our partners template is used.
 *
 * @package WordPress
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-7">
                <div class="copy-description cl-stormy-sea text-center">
                    <?php the_content(); ?>
                </div>
            </div>
        </div>
...
<?php if( have_rows('logos_partners_list') ): ?>
    <section class="section-logos-partners bg-white wow fadeIn" data-wow-duration="1s" data-wow-delay="1s">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-9">
                    <?php $title = get_field('title_section_logos'); ?>
                    <?php if( $title ): ?>
                        <h6 class="title-description-section cl-ultra-violet text-center  pb-5 pt-3"><?php echo $title;?></h6>
                    <?php endif; ?>
                    <div class="row equal align-items-start justify-content-between">
                        <?php  while( have_rows('logos_partners_list') ) : the_row();
                            $logo = get_sub_field('logo_partner');
                            $logolink = get_sub_field('link_partner');
                            ?>
                            <div class="col-6 mb-3 mt-3 mb-md-5 mt-md-5">
                                <?php if( !empty($logo) ): ?>
                                    <?php  if($logolink) {
                                    ...
                                    <?php } ?>
                                    <img class="logo-partner img-fluid m-auto" src="<?php echo esc_url($logo['url']); ?>" alt="<?php echo esc_attr($logo['alt']); ?>" />
                                    <?php  if($logolink) {  ?>
                                        </a>
                                    <?php } ?>
                                <?php endif; ?>
...
<section class="section-info-page bg-white wow fadeIn" data-wow-duration="0.5s" data-wow-delay="0.5s">
      <div class="container">
          <div class="row justify-content-center">
              <div class="col-md-10">
