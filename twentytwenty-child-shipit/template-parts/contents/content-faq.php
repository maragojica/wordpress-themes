<?php
/**
 * Displays the content when the faq template is used.
 *
 * @package WordPress
                    ...
                    <?php if( have_rows('banner_menu_inside') ): ?>
                        <div class="menu-sub-inside d-md-flex flex-wrap justify-content-center align-items-end hide-md">
                            <?php  while( have_rows('banner_menu_inside') ) : the_row();
                                ...
                                if( $page ):
                                    ?>
                                    <a data-content="<?php echo esc_html( $page->post_title ); ?>" class="cl-stormy-sea cl-stormy-sea-h position-relative<?php if($page_id == $link_id): echo " active"; endif;?>" href="<?php echo get_permalink($link_id); ?>"><span><?php echo esc_html( $page->post_title ); ?></span></a>
                                <?php endif; ?>
                            <?php endwhile; ?>
                        </div>
                    <?php endif; ?>
                            ...
                            <?php $i = 1;  while( have_rows('faq_list') ) : the_row();
                                ...
                                <div class="card card-faq">
                                    <div class="card-header">
                                        <?php if( $question ): ?>
                                            <a class="card-link" data-content="<?php echo $question; ?>" data-toggle="collapse" href="#collapse<?php echo $i; ?>">
