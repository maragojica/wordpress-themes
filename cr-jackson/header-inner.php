...
<head>
	...
	<link rel="stylesheet" href="https://use.typekit.net/jzu8qej.css">
	<?php wp_head(); ?>
</head>
...
<header id="masthead" class="site-header inner-header main-navigation">
	<div class="container">
						...
						if ($logo_url) {
							if ($logo_mime_type == 'image/svg+xml') {
								...
								<a tabindex="0" href="<?php echo esc_url(home_url('/')); ?>" rel="home" aria-label="<?php echo get_bloginfo('name'); ?> Logo" title="<?php echo get_bloginfo('name'); ?> Logo">
									<img class="logo" src="<?php echo esc_url($logo_url); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?> Logo" width="119" height="80"/>
								</a>
							<?php }
						}
					} ?>
					...
					if ($logo_url) {
						if ($logo_mime_type == 'image/svg+xml') {
							...
							<a class="flex" tabindex="0" href="<?php echo esc_url(home_url('/')); ?>" rel="home" aria-label="<?php echo get_bloginfo('name'); ?> Logo" title="<?php echo get_bloginfo('name'); ?> Logo">
								<img class="skip-lazy" src="<?php echo esc_url($logo_url); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?> Logo" width="80" height="80"/>
							</a>
						<?php }
					}
				} ?>
