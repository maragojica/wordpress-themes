<?php       
if (have_rows('info_text_company')) :          
    while (have_rows('info_text_company')) : the_row();
        ...
        <section class="section-info-text <?php if($reverse_mobile): echo ' back-and-forth-reverse-mv'; endif; if($padding_top_mobile){ echo ' back-and-forth-top-mv'; }else { echo ' back-and-forth-top-mv-0'; } if($padding_bottom_mobile){ echo ' back-and-forth-bottom-mv'; }else { echo ' back-and-forth-bottom-mv-0'; } ?>">
            <div class="container">
                <div class="row middle-xs <?php echo ($image_position['value'] == "right") ? 'reverse' : 'normal'; if($reverse_mobile): echo ' column-reverse-mv'; endif; ?>">     
                  <div class="col-img col-xs-12 col-lg-6 mb-lg-0 mt-lg-0 <?php echo ($image_position['value'] == "right") ? 'm-b4' : 'm-t4'; ?>">
                    <div class="media-content animate__animated" data-animation="<?php echo ($image_position['value'] == "right") ? 'fadeRight' : 'fadeLeft';?>" >
                        ...
                        <img class="img-logo-company" src="<?php echo esc_url($logo['url']); ?>" alt="<?php echo esc_attr($logo['alt']); ?>" height="138" srcset="<?php echo esc_attr($srcset); ?>" sizes="<?php echo esc_attr($sizes); ?>"/>                            
                    <?php endif; ?>
                    </div> 
                  </div>               
                    <div class="col-info col-xs-12 col-lg-6 <?php echo ($image_position['value'] == "right") ? 'pe-lg-3' : 'ps-lg-3'; ?>">
                        <?php if ($subheading) : ?>
