       ...
       <div class="container-fluid pt-5 pb-5">
            <div class="row">
                <div class="col-md-12 pt-5 pb-5">       
                      ...
                      <h1 class="title-section cl-l-blue text-center">
                      <?php if ( has_post_thumbnail() ) {
                            ...
                            <?php } ?>  
                        <?php the_title(); ?>
                        <?php $position = get_field('position_team');  ?>
                        <?php if( $position ): ?>
                            <div class="position-team cl-l-blue" style="color: #c9e7e7; !important;"><?php echo $position; ?></div>
                        <?php endif; ?>
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="box-info-single">                       
                        ...
                        <?php  $linkedin_team = get_field('linkedin_team'); ?>
