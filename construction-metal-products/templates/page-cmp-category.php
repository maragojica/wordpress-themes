<?php
/**
 * The template for displaying cmp products category
 * Template Name: CMP Products Category
    ...
    <section class="section-content-cmp p-b0">
        <div class="container">
            <div class="row row-sidebar">
                ...
                <?php get_template_part('template-parts/sections/section-products-cat'); ?>
                </div>
