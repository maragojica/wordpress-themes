<?php
/**
 * The template for displaying cmp products page
 * Template Name: CMP Products
    ...
    <section class="section-content-cmp p-b0">
        <div class="container">
            <div class="row row-sidebar">
                <div class="col-xs-12 col-xl-8 ps-0 pe-0 pe-xl-2">
                <?php get_template_part('template-parts/sections/section-products-list');   
                    get_template_part('template-parts/sections/section-info-full-image');
                ...
                <div class="col-xs-12 col-xl-4 m-t3 mt-lg-0">
