<?php 
if (have_rows('info_center')) :          
    while (have_rows('info_center')) : the_row();
            ...
            <?php if($headline ||  $subheading): ?>
                ...
                <div class="col-xs-12 col-lg-8 col-xl-6 text-center">                    
                    ...
                    <?php if (have_rows('button_list')) {  ?> 
                        <div class="button-list-info justify-center mt-20px wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.5s">  
