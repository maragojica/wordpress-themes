                ...
                <div class="container">
                    <div class="row middle-xs justify-center">
                        ...
                        <div class="w-100 text-center wow fadeIn" data-wow-duration="0.3s" data-wow-delay="0.1s"> 
                                ...
                                <?php if ($description) : ?>
                                    <div class="dp-2 cl-white wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.4s"><?php echo wp_kses_post($description); ?></div>
                                <?php endif; ?>   
                                <?php if (have_rows('button_list')) {  ?> 
                                    <div class="button-list-info wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.5s">  
