...
if (have_rows('internal_banner')) {
    ...
    <section <?php if($section_id): ?> id="<?php echo $section_id;?>" <?php endif; ?> class="page-internal-hero flex w-margin <?php if(!$margin_top_desktop): echo ' mt-0'; endif; if(!$margin_bottom_desktop): echo ' mb-0'; endif; if(!$margin_top_mobile): echo ' m-mv-t0'; endif; if(!$margin_bottom_mobile): echo ' m-mv-b0'; endif; ?>" <?php if($banner_type['value'] == "image" && !empty($banner_image)): ?>style="background: url(<?php echo esc_url($banner_image['url']); ?>)"<?php endif; ?>>            
        <?php if($banner_type['value'] == "video"){  ?> 
            ...
            <?php } ?>  
            <div class="overlay flex middle-lg bottom-xs" <?php if( $bg_overlay ): ?> style="background-color: <?php echo $bg_overlay; ?>" <?php endif; ?>> 
                <div class="container">
                    <div class="row middle-xs">
                        <div class="col-xs-12 col-lg-9 col-xl-7">
                        <div class="<?php if($add_text_box_style){ ?>box-banner <?php } ?> w-100 wow fadeIn" data-wow-duration="0.3s" data-wow-delay="0.1s">          
                               <?php if ($subheadline) : ?>
                                    <div class="subheadline cl-black pb-17px text-uppercase wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.2s"><?php echo $subheadline; ?></div>
                                <?php endif; ?>      
                                <?php if ($headline) : ?>
                                    <h1 class="<?php if($add_text_box_style){ ?>c-black <?php }else{ ?>cl-white <?php } ?> mt-0 mb-10px text-uppercase wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.2s"><?php echo $headline; ?></h1>
                                <?php endif; ?>
                                <?php if ($description) : ?>
                                    <div class="dp-2 <?php if($add_text_box_style){ ?>c-black <?php }else{ ?>cl-white <?php } ?> wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.2s"><?php echo wp_kses_post($description); ?></div>
                                <?php endif; ?>   
