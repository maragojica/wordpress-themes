...
(function ($) {
  ...
  var findOfficeBorders = function findOfficeBorders() {
    ...
    $(".section-offices .office").each(function () {
      ...
      if (Math.abs(elem.offset().top + elem.height() - (boxOffset.top + box.height())) > elem.height()) $(this).addClass('has-bottom');
      if (elem.offset().left - boxOffset.left > 10) $(this).addClass('has-left');
    });
  };
