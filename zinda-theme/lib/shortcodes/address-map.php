            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="hc-map__address">
                        ...
                        <?php if($email) { ?>
                            <p>Correo electrónico: <a class="address__link_" href="mail:<?php echo $email; ?>"><?php echo $email; ?></a></p>
                            <?php
                        } ?>
                        <?php if($phone) { ?>
                            <p>Teléfono: <a class="address__link_" href="tel:<?php echo $phone; ?>"><?php echo $phone; ?></a></p>
                            <?php
                        } ?>
                        <?php if($fax) { ?>
