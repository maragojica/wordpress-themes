	...
	<header id="masthead" class="site-header">
		<div class="container-fluid">
			<div class="row desktop center-xs middle-xs">
						...
						if ($logo) {
							...
							if ($logo_url) {
								if ($logo_mime_type == 'image/svg+xml') {
									...
									<a class="flex" tabindex="0" href="https://celedore.com/" rel="home" aria-label="<?php echo get_bloginfo('name'); ?> Logo" title="<?php echo get_bloginfo('name'); ?> Logo">
										<img class="logo" src="<?php echo esc_url($logo_url); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?> Logo" width="238" height="55"/>
									</a>
								<?php }
							}
						} ?>
				...
				<div class="col-xs-12 col-lg-6 flex end-xs">
