            ...
            <?php if ($subheadline) : ?>
               ...
               <?php endif; ?>   
                <?php if($gravity_shortcode): ?>
                    <div class="gravity-form center wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"><?php echo $gravity_shortcode;?></div>
                <?php endif; ?>            
            </div>
        </div>           
    </div> 
