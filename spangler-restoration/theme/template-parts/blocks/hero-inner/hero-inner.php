...
?>
<section class="hero-inner-section max-w-full relative <?php echo esc_attr($className); ?>" <?php echo $anchor_attr; ?>>
<div class="max-w-full z-[3] h-[700px] md:h-screen lg:h-screen 2xl:h-[950px] relative bg-cover bg-center bg-no-repeat <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php if(!empty($image)):?>style="background-image: url(<?php echo esc_url($image['url']); ?>)"<?php endif; ?> data-aos="fade-in">
     ...
     <div class="container mx-auto h-full <?php echo esc_attr($container_classes); ?> relative">     
        <?php if($subheading): ?>
         ...
         <?php if ($heading) : ?>                 
           ...
           <?php endif; ?>            
           <?php if($description): ?>
                <div class="text-white text-sub-medium style-disc lg:max-w-[75%] 2xl:max-w-[80%] <?php if($alignment_hori == 'middle'): ?> mx-auto <?php endif; ?>" data-aos="fade-up">                 
   ...
   <?php if($add_bottom_shape): $shape_color = $hero['shape_color']; ?>
    ...
    <svg viewBox="0 0 1930 84" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: auto;">
        ...
        <path d="M1555.78 13.9838H1449.55H0V83.759H1929.5V34.9597H1860.64H1742.85L1682.81 0L1555.78 59.016V13.9838Z" fill="white"/>
        <?php else: ?>
            <path d="M1555.78 13.9838H1449.55H0V83.759H1929.5V34.9597H1860.64H1742.85L1682.81 0L1555.78 59.016V13.9838Z" fill="#F7F7F7"/>
        <?php endif; ?>    
    </svg>
    </div>
    <?php endif; ?>
