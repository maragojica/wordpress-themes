...
if (have_rows('journey_slider')) {
    while (have_rows('journey_slider')) {
        ...
        <section class="section-journey-slider section-featured-reviews">
            <div class="container position-relative">
                <div class="flex row center-xs middle-xs">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                       
                        <?php if ($heading) : ?>
                            <h2 class="cl-blue center-text mt-0 mb-40 animate__animated" data-animation="fadeBottom" data-duration="1s"><?php echo esc_html($heading); ?></h2>
                        <?php endif; ?>                                          
                    </div>
                </div>
                <?php 
                            ...
                            <div class="history-slide position-relative slide">                                 
                                <div class="row middle-xs h-100 ms-0 me-0">
                                    <div class="slider-text col-xs-12 col-sm-12 col-md-6 col-lg-6 h-100 ps-0 pe-0">
                                        ...
                                        <?php if ($description) : ?>
                                            <div class="dp-1 desc-reviews mt-08 mb-0 cl-black"><?php echo ($description); ?></div>
                                        <?php endif; ?>     
                                        <?php if ($subheading) : ?>
                                            <div class="feat-review-title cl-black mt-30 mb-0"><?php echo esc_html($subheading); ?></div>
                                        <?php endif; ?>  
                                        </div>
                                    </div>
