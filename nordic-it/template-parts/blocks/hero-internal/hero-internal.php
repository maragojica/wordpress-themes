...
<section class="hero-internal-section max-w-full lg:h-fit relative custom-green-gradient-inner <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
   ...
   <div class="relative h-full <?php if(!empty($image)):?> bg-cover <?php echo $bg_position;?> bg-no-repeat <?php if($bg_fixed):?> sm:bg-fixed <?php endif; endif; ?>" <?php if(!empty($image)):?>style="background-image: url(<?php echo esc_url($image['url']); ?>)"<?php endif; ?>>
       <div class="overlay text-center flex flex-col items-center justify-center h-full w-full lg:pt-[120px] lg:py-[120px] pt-[80px] py-[80px] lg:px-0 px-[2em]" <?php if($bg_color):?> style="background-color: <?php echo $bg_color;?>" <?php endif; ?>>
       <?php if ($subheading) : ?>
            <h3 class="<?php echo $subheading_color; ?> bodymedium animate__animated" data-animation="fadeIn" data-duration="1.2s">
                <?php echo $subheading; ?>
            </h3>
        <?php endif; ?>
        <?php if ($heading) : ?>
        ...
        <?php if ($description) : ?>
            <div class="bodymedium mt-[10px] font-text-font <?php echo $description_color; ?> md:max-w[80%] lg:max-w-[70%] mx-auto animate__animated" data-animation="fadeIn" data-duration="1.4s">
