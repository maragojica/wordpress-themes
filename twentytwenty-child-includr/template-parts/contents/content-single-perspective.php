<?php
/**
 * The default template for displaying single perspective content
 *
		...
		<div class="container">
			<div class="row row-center-lg equal ml-md-auto align-items-md-center">
				...
				<div class="col-md-7">
					...
					<div class="row equal justify-content-sm-between align-items-center">
						<div class="col-lg-7 text-md-left text-center">
							<div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
								<div>
									<h4 class="title-info title-info-cate cl-purple-dark pb-3">In Perspective</h4>
								...
								<div class="quote-author quote-author-sm d-flex align-items-center justify-content-center">
									<?php $authorimg = get_field('author_photo_pers');
									 if( !empty($authorimg) ){ ?>
									...
									<div class="pl-3 text-left">
										<?php $author = get_field('author_name_pers');
										if( $author ){
											$author_name = $author;
					...
					<?php
					$number_percent = get_field('number_percent_pers');
					$img_percent = get_field('image_percent_pers');
					$text_percent = get_field('text_percent_pers');
					if( $text_percent ): ?>
					<hr>
					...
					<hr>
					<?php endif; ?>
					<?php $textinfo1 = get_field('info_text_1_pers'); ?>
					<?php if( $textinfo1 ): ?>
					<div class="mt-5">
					...
					<?php endif; ?>
					<?php $titletinfo1 = get_field('title_info_text_1'); ?>
					<?php if( $titletinfo1 ): ?>
							<div class="m-less">
								<hr>
					...
					<?php endif; ?>
					<?php $textinfo2 = get_field('info_text_2_pers'); ?>
					<?php if( $textinfo2 ): ?>
					...
					<?php endif; ?>
					<?php if( have_rows('list_related') ):
						$title = get_field('title_related');
						$count = count(get_field('list_related'));?>
					<div class="mt-5 pt-5">
						<?php if( $title ): ?>
						<h4 class="title-info cl-green-dark mb-md-5 mb-4"><?php echo $title;?></h4>
						<?php endif; ?>
						<?php $i=1; while( have_rows('list_related') ) : the_row();
							$image = get_sub_field('image_related');
							$name = get_sub_field('name_related');
							$position = get_sub_field('position_related');
							$text = get_sub_field('text_related');
							?>
					...
					<?php
					$id = get_the_ID();
					$terms = wp_get_post_terms( $id , 'perspective_tag' );
					if ( $terms != null ){?>
