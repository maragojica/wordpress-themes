<?php
/**
 * Header Dark file for the Twenty Twenty WordPress default theme.
 *
...
<header id="site-header" class="header-footer-group header-dark" role="banner">
		...
		<div class="container">
			<div class="row row-top-header equal align-items-center">
				...
				<div class="col-6 pr-0 pl-0 text-center h-100 align-items-center justify-content-center d-flex">
                    <div class="site-logo faux-heading"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="custom-logo-link" rel="home"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/footer-logo.png" class="custom-logo" alt="Logo Includr"></a><span class="screen-reader-text">Includedr</span></div>
				</div>
