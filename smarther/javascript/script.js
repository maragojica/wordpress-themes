...
// 4. Search Bar Popup
// 5. Custom Videos
// 6. Quick Exit (Emergency Exit) Functionality
// 7. Load More Events
// 8. Load More News
...
/*--------------------------------------------------------------
# Quick Exit (Emergency Exit) Functionality
--------------------------------------------------------------*/
document.addEventListener('DOMContentLoaded', function() {
    const exitBtn = document.getElementById('emergency-exit-btn');
    
    if (exitBtn) {
        exitBtn.addEventListener('click', function(e) {
            e.preventDefault();
            
            const exitUrl = this.getAttribute('data-exit-url') || 'https://www.google.com';
    ...
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape' && exitBtn) {
            e.preventDefault();
            const exitUrl = exitBtn.getAttribute('data-exit-url') || 'https://www.google.com';
            window.location.replace(exitUrl);
        }
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Initially hide all, then show first 9
	postCards.forEach(card => card.style.display = 'none');
	showPosts();
