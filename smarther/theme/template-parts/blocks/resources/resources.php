...
<section class="resources-section max-w-full relative overflow-hidden <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
    ...
    <div class="container mx-auto relative z-[2]">
        ...
        <!-- Resources Grid -->
        <?php if ($resources) : ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 md:gap-x-[50px] gap-y-8 lg:gap-y-[80px] grid-resources" data-aos="fade-up">
               <?php foreach ($resources as $column): 
                ...
                <div class="event-card flex flex-col h-full">
                    ...
                    <div class="event-conten bg-white group lg:pt-[58px] pt-[35px] px-[34px] lg:pb-[50px] pb-[35px] flex flex-col flex-grow rounded-b-[10px]">  
                        <div class="resource-title flex-grow">
                         ...
                         <!-- CTA Resources -->
                        <?php if ($buttons_cta) : ?>
                        <div class="flex flex-wrap gap-2 lg:gap-8 lg:mt-[38px] mt-[24px] justify-center" data-aos="fade-up">
