<?php
$content_block = get_field('content_block_smarther');
if ($content_block) {
...
<section class="back-foth-smarther-section max-w-full relative overflow-hidden <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>   
    <?php if (!$settings) { ?>  
    ...
    <div class="hidden md:block w-full px-[30px] xl:pl-[38px] xl:pr-[90px] mx-auto pt-[33px] relative z-2" data-aos="fade-up">
        ...
        <div class="space-y-6">
            ...
            foreach ($image_chunks as $row_images): ?>
                ...
                <div class="grid-gallery grid grid-cols-12 grid-rows-6 gap-[25px] xl:gap-[35px] md:h-[20em] lg:h-95 xl:h-[340px]">
...
<?php endif; ?>
    <?php } else { 
            include get_template_directory() . '/template-parts/global/global-back-forth-smarther.php'; 
        } ?>  
</section>
