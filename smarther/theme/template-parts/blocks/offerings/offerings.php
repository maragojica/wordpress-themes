...
$content_block = get_field('content_block_offerings');
if ($content_block) {
    ...
    $offerings = $content_block['offerings'];
...
<section class="offerings-section max-w-full relative overflow-hidden <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
    ...
    <div class="container mx-auto relative z-[2]">
        ...
        <!-- Header Section -->
        <div class="text-center mb-12 md:max-w-[50%] mx-auto" data-aos="fade-in">
             <?php if($subheading): ?>
        ...
        <?php if ($offerings) : ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-8 md:gap-x-[50px] gap-y-8 lg:gap-y-[80px] grid-offerings lg:mt-[80px] mt-[3em]" data-aos="fade-up">
               <?php foreach ($offerings as $column): 
                ...
                <div class="offer-card flex flex-col h-full justify-between align-items-center">  
                    <div class="offer-content group flex flex-row lg:gap-x-[26px] gap-x-[15px]">  
                        <?php if(!empty($icon)): ?>
                            <div class="icon flex-shrink-0">
                                <img src="<?php echo esc_url($icon['url']); ?>" alt="<?php echo esc_attr($icon['alt']); ?>" class="lg:w-[47px] lg:h-[47px] w-[35px] h-[35px]" />
                            </div>
                        <?php endif; ?>
                        <div class="offer-info flex-grow">
                            <?php if($title): ?>
                            ...
                            <?php endif; ?>
                            <?php if($text): ?>
                                <div class="text-foreground text-foreground style-disc">
                                    <?php echo $text; ?>
                                </div>
                            <?php endif; ?>
                        </div>              
        ...
        <?php endif; ?>
          <?php if ($heading) : ?>
                <div class="w-full flex flex-col gap-y-[10px] mt-[50px]">
                    <div class="w-full h-[2px] bg-primary"></div>
                    <div class="w-full h-[2px] bg-primary"></div>
                </div>
                <h3 class="text-foreground mb-0 text-center lg:mt-[80px] mt-[2em]" >
                    <?php echo $heading; ?>
                </h3> 
        <?php endif; ?> 
        ...
        <!-- CTA Button -->
        <?php if ($buttons) : ?>
        <div class="flex flex-wrap gap-2 lg:gap-8 mt-[30px] justify-start" data-aos="fade-up">
