...
<section class="hero-section max-w-full relative <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?> <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?>> 
    <div class="box-media-hero  w-full lg:h-[550px] md:h-[30em] h-[20em] relative flex items-stretch bg-cover bg-no-repeat bg-center" <?php if($media_type['value'] == "image"){ if($image): ?>style="background-image: url('<?php echo esc_url($image['url']); ?>');" <?php endif; } ?>>
    ...
    <?php if($heading || $description || ($buttons && !empty($buttons)) ): ?>              
                <div class="container mx-auto -mt-[40px] lg:-mt-[55px] relative z-[2]" data-aos="fade-in">
                    <div class="bg-white rounded-[10px] lg:py-[75px] lg:px-[121px] md:px-[3em] md:py-[3em] px-[2em] py-[2em] shadow-custom text-center">
                        ...
                        <?php endif; ?> 
                            <?php if ($heading) : ?>
                            <h2 class="text-foreground mb-0" data-aos="fade-up" >
                                <?php echo $heading; ?>
                            </h2> 
                        <?php endif; ?> 
                            <?php if($description): ?>
                            <div class="text-large text-foreground style-disc mt-5" data-aos="fade-up" >                 
