...
<div class="container mx-auto relative z-[2]">             
    <div class="flex flex-col lg:flex-row flex-col items-stretch lg:gap-y-0 gap-y-[3em]">
       <div class="w-full lg:w-[55%] flex flex-col lg:pr-[60px] lg:pl-0 justify-start">
         <?php if(!empty($image)): ?>
        ...
        <h2 class="text-foreground" data-aos="fade-in">                 
         ...
         <?php endif; ?>           
           <?php if($description): ?>
            <div class="text-large text-foreground style-disc mt-[20px]" data-aos="fade-in" >                 
       ...
       <div class="w-full lg:w-[45%] flex flex-col" data-aos="fade-in">
         <?php if($form_shortcode): ?>
            <div class="contact-form bg-white rounded-[10px] w-full h-full flex justify-center flex-col px-[2em] py-[2em] lg:py-[35px] lg:px-[45px]">
                    <?php if ($form_title) : ?>
                    <h2 class="text-foreground mb-[20px]" data-aos="fade-up" >
                        <?php echo $form_title; ?>
                    </h2> 
                <?php endif; ?> 
                <?php if($form_text): ?>          
                ...
                <?php endif; ?> 
                <?php if($form_shortcode): ?>
                <div class="md:mt-[20px]"><?php echo do_shortcode($form_shortcode);  ?></div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
       </div>
