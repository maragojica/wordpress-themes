...
if ($content_block) {
    ...
    $add_heading_shape = $content_block['add_heading_shape'];
...
<section class="info-text-section max-w-full relative <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?> <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?>> 
    <div class="container mx-auto">     
       <div class="<?php echo esc_attr($container_classes); ?>">
          <div class="<?php echo esc_attr($heading_width); echo $class_text; ?>">
                    <?php if($subheading): ?>
                    <div class="eyebrow text-quaternary mb-[20px]"  data-aos="fade-in">
                        <?php echo $subheading; ?>
                    </div>   
                <?php endif; ?> 
                    <?php if($main_heading): ?>
                    <h1 class="text-foreground mb-0 <?php if( $add_heading_shape ): ?> heading-shape <?php endif; ?>">
                        <?php echo $main_heading; ?>
                    </h1>
                <?php endif; ?>
                 <?php if($description): ?>
                    <div class="text-large text-foreground style-disc mt-5 lg:mt-8 <?php if($text_align === 'center'):?> mx-auto lg:max-w-[55%] <?php endif; ?>" data-aos="fade-in" >                 
                        <?php echo $description; ?>                   
                    </div>
                 <?php endif; ?>                
               <?php if ($buttons) : ?>
                <div class="flex flex-wrap justify-center gap-2 lg:gap-8 mt-6 <?php if(!$description){ ?> lg:mt-[70px] <?php } ?>  <?php echo $btn_align;?>" data-aos="fade-up">
