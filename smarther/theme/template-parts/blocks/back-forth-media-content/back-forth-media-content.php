...
<section class="back-foth-media-content-section max-w-full relative overflow-hidden <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>   
     <?php if($add_top_corner_shape){ $top_corner_shape = $content_block['top_corner_shape'];?>
        <div class="absolute left-0 z-1 shape-top-corner top-0 md:max-w-fit max-w-[50%]" data-aos="fade-in">
    ...
    <?php } ?>
     <?php if($add_bottom_corner_shape){ $bottom_corner_shape = $content_block['bottom_corner_shape'];?>
        <div class="absolute right-0 z-1 shape-bottom-corner bottom-0 md:max-w-fit max-w-[50%]" data-aos="fade-in">
...
<div class="container mx-auto pb-[3em]">             
    <div class="relative flex items-center justify-center text-center">
        <h2 class="text-foreground mb-0 md:max-w-fit  <?php if($bg_color): echo $bg_class; endif; ?> z-[3]" data-aos="fade-in">                 
                    <span <?php if($heading_separator): ?> class="md:px-[60px]" <?php endif; ?>><?php echo $main_heading; ?></span> 
         </h2>
         <?php if($heading_separator): ?>
            <div class="w-full absolute left-0 right-0 top-1/2 -translate-y-1/2 hidden md:flex flex-col gap-y-[10px] z-[2]">
...
<?php endif; ?>
     <?php $i = 1; if( $list_content ): ?> 
        ...
        <div class="container mx-auto">  
          <div class="w-full <?php if(!$full_content){ ?> mx-auto lg:max-w-[75%] <?php } ?>">   
           <div class="<?php echo esc_attr($container_classes); ?> lg:gap-y-0 gap-y-[3em] lg:mt-[30px] <?php if($i > 1){ echo ' mt-[3em]'; } ?>">               
              <div class="<?php echo esc_attr($heading_width); ?> px-[2rem] <?php echo $row_gap_class; ?> <?php echo $columns_gap_class; ?>  justify-center">
                    ...
                    <?php endif; ?> 
                        <?php if($description): ?>
                        <div class="<?php echo esc_attr($text_size_class); ?> text-foreground style-disc mt-[15px]" data-aos="fade-in" >                 
                ...
                <div class="<?php echo esc_attr($content_width); ?>" <?php if($reverse_desktop){ ?> data-aos="fade-left" <?php }else{ ?> data-aos="fade-right" <?php } ?>  >  
                    <div class="w-full lg:h-full md:h-[25em] sm:h-[20em] h-[15em] relative rounded-[10px] rounded-video bg-cover bg-top bg-no-repeat" <?php if($media_type['value'] == "image"){ ?> style="background-image: url('<?php echo esc_url($image['url']); ?>');" <?php } ?>>
   ...
   <?php $i++; endforeach; endif; ?>
       <?php if ($buttons_general) : ?>
        <div class="container mx-auto pt-[4em]"> 
                        <div class="flex flex-wrap gap-2 lg:gap-8 mt-[15px] justify-center" data-aos="fade-up">
