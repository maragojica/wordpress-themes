...
$content_block = get_field('content_block_news');
if ($content_block) {
    ...
    $news_display = $content_block['news_display']; // Button group: 'last_3' or 'all'
...
<section class="news-section max-w-full relative overflow-hidden <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
    ...
    <div class="container mx-auto relative z-[2]">
        ...
        <?php if ($news->have_posts()) : ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8 lg:gap-y-[80px]" data-aos="fade-up">
                ...
                <div class="event-card <?php if( $count_allpost > 6): ?> news-item <?php endif; ?>">
                    ...
                    <div class="event-content group">
                        ...
                        <div class="event-title text-[22px] mt-[10px] text-foreground">
                            <a  href="<?php echo esc_url(get_permalink()); ?>" aria-label="<?php echo esc_html($news_title); ?>" title="<?php echo esc_html($news_title); ?>" tabindex="0">
