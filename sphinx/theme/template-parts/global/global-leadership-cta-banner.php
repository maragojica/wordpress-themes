<?php
$content_block = get_field('content_block_leadership_cta_banner', 'option');
if ($content_block) {
...
<section class="leadership-cta-banner-section max-w-full relative z-[2] <?php echo esc_attr($bg_class); ?> h-auto overflow-hidden <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" > 
