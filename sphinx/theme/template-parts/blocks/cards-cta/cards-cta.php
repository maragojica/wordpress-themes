<?php
$content_block = get_field('content_block_cards_cta');
if ($content_block) {
    ...
    switch ($columns_layout) {
        case 'one':
            $info_ontainer_classes = ' grid-cols-1 ';
            $info_list_class = ' lg:max-w-[65%] xl:max-w-[845px]';
            break;
        case 'two':
            $info_ontainer_classes = ' grid-cols-1 md:grid-cols-2 ';
            $info_list_class = ' lg:max-w-[80%] 2xl:max-w-[85%]';
            break;
        case 'three':
        default:
            $info_ontainer_classes = ' grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ';
            $info_list_class = ' lg:max-w-[80%] 2xl:max-w-[85%]';
            break;
    }

     $info_ontainer_classes = 'w-full grid gap-y-[25px] md:gap-x-[44px] md:gap-y-[44px] justify-items-center '.$info_ontainer_classes;
?>

<section class="cards-cta-section max-w-full h-auto relative  <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
      <div class="container mx-auto"> 
              ...
              <div class="w-full text-center">
                   <?php if($subheading): ?>
                    ...
                    <?php endif; ?> 
                        ...
                        <?php if($description): ?>
                        <div class="text-large text-white style-disc mt-5 lg:mt-[30px] mx-auto lg:max-w-[55%]" data-aos="fade-up" data-aos-delay="100" >                 
          ...
          <?php if( $info_list ): ?> 
            <div class="max-w-full <?php echo esc_attr($info_list_class); ?> mx-auto">
                <div class="<?php echo esc_attr($info_ontainer_classes); ?> <?php echo ($subheading || $heading || $description) ? ' mt-[40px]' : ''; ?>">
                 <?php $i = 0; foreach ($info_list as $column): 
                   
                    $title = $column['title']; 
                     $text = $column['text'];                      
                    $buttons = $column['buttons'];   ?>
                    <div class="w-full" data-aos="fade-up" data-aos-delay="<?= $i * 100 ?>">  
                         <div class="cards-info flex flex-col justify-between w-full h-full items-left text-left px-[25px] py-[25px] lg:px-[44px] lg:py-[37px] bg-transparent border-[2px] border-primary rounded-[3px] transition-transform duration-300">                      
                            <div>
                                <?php if($title): ?>
                            ...
                            <?php endif; ?> 
                              ...
                              <?php if ($buttons) : ?>
                        <div class="flex flex-wrap justify-start gap-3 lg:gap-8 mt-6 lg:mt-[30px] w-full" data-aos="fade-up" data-aos-delay="100">
