...
if ($content_block) {
    ...
    $description_top = $content_block['description_top']; 
    $description_bottom = $content_block['description_bottom'];
    ...
    $column_container_classes = 'w-full md:p-x-[25px]';
    switch ($columns_layout) {
        case 'three':
            $column_container_classes .= ' md:w-1/2 lg:w-1/3 ';
            break;
        case 'four':
            $column_container_classes .= ' md:w-1/2 lg:w-1/4 ';
            break;
        case 'five':
        default:
            $column_container_classes .= ' md:w-1/2 lg:w-1/5 ';
            break;
    }

     $info_container_classes = 'w-full flex flex-wrap  gap-y-[25px] md:gap-y-[44px] justify-center items-center ';
?>

<section class="cards-icons-section max-w-full h-auto relative  <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
      <div class="container mx-auto"> 
              ...
              <div class="w-full text-center">
                   <?php if($subheading): ?>
                    ...
                    <?php endif; ?>                        
                        ...
                        <div class="text-large text-white text-center style-disc mt-5 lg:mt-[30px] mx-auto lg:max-w-[55%]" data-aos="fade-up" data-aos-delay="100" >                 
          ...
          <?php if( $info_list ): ?> 
            <div class="max-w-full lg:max-w-[80%] xl:max-w-[85%] mx-auto">
                <div class="<?php echo esc_attr($info_container_classes); ?> <?php echo ($subheading || $heading || $description) ? ' mt-[40px]' : ''; ?>">
                 <?php $i = 0; foreach ($info_list as $column): 
                    ...
                    <div class="<?php echo esc_attr($column_container_classes); ?>" data-aos="fade-up" data-aos-delay="<?= $i * 100 ?>">  
                         <div class="cards-info flex flex-col justify-between w-full h-full items-center text-center bg-transparent transition-transform duration-300">                      
                            <div class="flex flex-col gap-y-[20px]">
                            <?php if($icon): ?>
                                <img src="<?php echo esc_url($icon['url']); ?>" alt="<?php echo esc_attr($icon['alt'] ? $icon['alt'] : $title); ?>" class="transition-all duration-300 h-[60px] lg:h-[100px] object-contain" />
                            <?php endif; ?>
                                <?php if($title): ?>
                                <h4 class="text-white mb-[10px]"><?php echo $title;?></h4>
                            <?php endif; ?> 
                             <?php if($text): ?>
                                <div class="text-white <?php if($title): ?> mt-2 <?php endif;?>" data-aos="fade-up" >                 
                                    <?php echo $text; ?>                   
                                </div>
                            <?php endif; ?> 
                            </div>
                              <?php if ($buttons) : ?>
                        <div class="flex flex-wrap justify-center gap-3 lg:gap-8 mt-6 lg:mt-[30px] w-full" data-aos="fade-up" data-aos-delay="100">
         ...
         <?php endif; ?>    
           <?php if($description_bottom): ?>
            <div class="text-large text-white style-disc mt-[50px] mx-auto lg:max-w-[76%] 2xl:max-w-[65%] text-center" data-aos="fade-up" data-aos-delay="100" >                 
