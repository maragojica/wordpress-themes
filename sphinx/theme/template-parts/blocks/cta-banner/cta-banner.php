<?php
$content_block = get_field('content_block_cta_banner');
if ($content_block) {
...
<section class="cta-banner-section max-w-full relative z-[2] <?php echo esc_attr($bg_class); ?> h-auto overflow-hidden <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?> <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?>> 
    <?php if($heading || $description || ($buttons && !empty($buttons)) ): ?>              
            <div class="container mx-auto text-center" data-aos="fade-in">  
                     <?php if($subheading): ?>
                    ...
                    <?php endif; ?> 
                        ...
                        <?php if($description): ?>
                        <div class="text-large <?php echo esc_attr($text_class); ?> style-disc mt-5 lg:mt-[30px] mx-auto lg:max-w-[76%] 2xl:max-w-[70%]" data-aos="fade-up" data-aos-delay="100" >                 
