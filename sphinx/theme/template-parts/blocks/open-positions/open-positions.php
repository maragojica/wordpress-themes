<?php
$content_block = get_field('content_block_opens_positions');
if ($content_block) {
    
    $heading = $content_block['heading'];      
    $subheading = $content_block['subheading']; 
    $description = $content_block['description']; 
    $positions = $content_block['positions'];     
...
<div class="w-full w-full z-[2] relative container ma-auto">
    <div class="w-full h-[1px] bg-[#F1F1F1]"></div>
</div>
<?php endif; ?>
<section class="open-positions-section max-w-full h-auto relative  <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
      <div class="container mx-auto"> 
        <div class="<?php echo esc_attr($container_classes); ?>">
            <div class="w-full text-left">
                ...
                <?php endif; ?>   
                <?php if($positions): ?>
                    <div class="positions-frame mt-[50px]"><?php echo $positions; ?></div>
                  <?php endif; ?>
                 <?php if ($buttons) : ?>
