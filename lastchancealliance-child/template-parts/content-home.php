...
<?php if( have_rows('banner_home') ): ?>
    <?php while( have_rows('banner_home') ): the_row();
        ...
        <section class="section-banner-homevideo section-banner d-flex align-items-center">
            <video src="https://lastchancealliance.org/staging/wp-content/themes/lastchancealliance-child/assest/videos/GP0STUN5Y_High_Res.mp4" loop muted autoplay>
            </video>
            <div class="overlay">
            <div class="container d-flex justify-content-center flex-column">
                ...
                <div class="row w-100">
                    <div class="col-md-12">
                        <a class="video-link" href="<?php echo $videoid;?>"  target="_blank"><i class="fab fa-youtube"></i><span><?php echo $videolink;?></span></a>
                    </div>
                </div>
                <?php endif; ?>
            </div>
                ...
                <div class="row">
                    ...
                    <?php if( $title ): ?>
                        ...
                        <!--<div class="card-ellipsis">
                            ...
                            <div class="ellipsis" speed="180"><?php /*echo $title;*/?></div>
                                ...
                                <div class="col-md-5">
                                   <?php if( get_field('testimonial_story') ): ?>
                                    <div class="box-testimonials">
                                        <div class="quotes mb-5 pb-3 pt-2">
                                        ...
                                        <div class="testimonial-single-story cl-dark pb-5 mb-5"><?php the_field('testimonial_story'); ?></div>
