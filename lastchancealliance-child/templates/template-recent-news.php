...
?>
    ...
    ?>
<?php if( have_rows('section_info_news') ): ?>
    <?php while( have_rows('section_info_news') ): the_row();

// Get sub field values.
        $title = get_sub_field('title_info_news');
        $text = get_sub_field('text_info_news');
        $cta = get_sub_field('cta_link_info_news');
        ?>
...
<script>
    jQuery('.loadmoreitems').simpleLoadMore({
        item: '.row-news-items',
        count: 4,
