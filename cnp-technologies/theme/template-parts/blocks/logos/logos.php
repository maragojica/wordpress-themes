...
<section class="logos-section max-w-full relative bg-white <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?> >
    <div class="container mx-auto">           
        ...
        <?php if ($heading) : ?>
                <h2 class="text-primary text-center mb-[20px] lg:mb-[1em] animate__animated" data-animation="fadeIn" data-duration="1.2s">
                    <?php echo $heading; ?>
                </h2>              
        <?php endif; ?>                           
        </div>
            ...
            <?php foreach ($logos_content as $column) : 
                ...
                <?php if(!empty($logo)): ?>
                    <?php  if($link) {
                        ...
                        <img class="logo-partner h-[60px]" src="<?php echo esc_url($logo['url']); ?>" alt="<?php echo esc_attr($logo['alt']); ?>" />
                    <?php if($link) { ?>
                        </a>
                    <?php } ?>
                <?php endif; ?>
