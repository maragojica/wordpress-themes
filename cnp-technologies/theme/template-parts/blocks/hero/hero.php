...
<section class="hero-section max-w-full bottom-shape custom-h h-[700px] md:h-[calc(90vh-101px)] lg:h-[calc(90vh-113px)] relative z-[1] bg-cover bg-fixed bg-center bg-no-repeat animate__animated <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?> <?php if(!empty($image)):?>style="background-image: url(<?php echo esc_url($image['url']); ?>)"<?php endif; ?> data-animation="fadeIn" data-duration="1.1s">
    <?php if($banner_type['value'] == "video"){ 
            ...
            <?php } ?>              
    <div class="overlay <?php echo esc_attr($container_classes); ?> absolute z-[2] top-0 left-0 bg-[linear-gradient(270deg,rgba(0,55,108,0)_-0.57%,rgba(0,55,108,0.5)_94.01%),linear-gradient(0deg,rgba(0,55,108,0.55)_0%,rgba(0,55,108,0.55)_100%)]" >
