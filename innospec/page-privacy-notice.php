<?php
//Template name: Page Privacy Notice
get_header();
?>
                        ...
                        <div class="<?php echo $col1; ?>">
                            ...
                            <div class="wrap-product wrap-content">
		                                    ...
		                                    <div class="flexslider">
											    <ul class="slides">
											    	<?php while( have_rows('banners') ) : the_row(); ?>
											      	<li>
											        	<img src="<?php echo get_sub_field('image') ?>" alt="Innospec Banner" />
											      	</li>
											      	<?php endwhile; ?>
											    </ul>
											</div>
                                ...
                                <div class="content-text">
                                    ...
                                    // Check rows exists.
                                    if( have_rows('privacies') ):
                                        echo "<div class='technicals'>";
                                        // Loop through rows.
                                        while( have_rows('privacies') ) : the_row();
                                            ?>
                                            <div class="inner-technical d-flex justify-content-between">
                                                <div>
                                                    <h3><?php the_sub_field('title'); ?></h3>
                                                </div>
                                                <div class="wrap-download">
                                                    <a href="<?php the_sub_field('file'); ?>" target="_blank"><img src="https://innospec.com/wp-content/themes/innospec/img/icon-download.png" width="25" alt="Innospec Image"></a>
                                                </div>
                                            </div>
                                            <?php
                                        // End loop.
