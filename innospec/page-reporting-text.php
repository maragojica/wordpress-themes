                ...
                <div id="app" class="wrap-grid">
                    ...
                    <div class="grid-body grid-vue sec-regulatory">                        
                        <div class="grid grid2" v-for="(item, index) in filteredRows" :key="index" :id="'id-'+index">
                            ...
                            <div class="links">
                                <span :title="item.content.filing_href" class="cursor" @click="export_pdf2(item.content.filing_href)">
                        ...
                        new Vue({
                            ...
                            methods:{
                                ...
                                export_word(url){
                                    ...
                                    var newUrl = path+'xslF345X03/doc4.xml'
                                    window.open(newUrl);
                                    //console.log(newUrl);
                                },
                                export_html(url){
                                ...
                                export_pdf(url, type){
                                    ...
                                    if(type == '4')
                                        var newUrl = path+'xslF345X03/doc4.xml'
                                    if(type == '8-K')
                                        var newUrl = path+'d456217d8k.htm'
                                    if(type == '10-K')
                                        var newUrl = path+'d260528d10k.htm'
                                    if(type == 'SC 13G/A')
                                        var newUrl = path+'tv01146-innospecinc.htm'
                                    if(type == 'SC 13G')
                                        var newUrl = path+'iosp223.txt'
                                    if(type == '10-Q')
                                        var newUrl = path+'d411458d10q.htm'
                                    if(type == 'SD')
                                        var newUrl = path+'d349339dsd.htm'
                                    if(type == 'DEFA14A')
                                        var newUrl = path+'d314952ddefa14a.htm'
                                    if(type == 'DEF 14A')
                                        var newUrl = path+'d314952ddef14a.htm'
