<?php
//Template name: Page Technical Papers
get_header();
?>
                        ...
                        <div class="<?php echo $col1; ?>">
                            ...
                            <div class="wrap-product wrap-content">
                                ...
                                <div class="content-text">
                                    ...
                                    // Check rows exists.
                                    if( have_rows('technicals') ):
                                        echo "<div class='technicals'>";
                                        // Loop through rows.
                                        while( have_rows('technicals') ) : the_row();
                                            ?>
                                            <div class="inner-technical d-flex justify-content-between">
                                                ...
                                                <div class="wrap-download">
                                                    <a href="<?php the_permalink(get_sub_field('file')); ?>" target="_blank"><img src="https://innospec.com/wp-content/themes/innospec/img/icon-download.png" width="25" alt="<?php echo get_sub_field('title') ?>"></a>
                                                </div>
                                            </div>
                                            <?php
                                        // End loop.
