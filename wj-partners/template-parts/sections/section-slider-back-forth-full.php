<?php       
if (have_rows('slider_back_forth_full')) :  ?>    
<div class="back-forth-slider owl-carousel owl-theme">    
  <?php  while (have_rows('slider_back_forth_full')) : the_row();
