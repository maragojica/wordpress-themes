            ...
            <div class="container p-lg-t2 p-t5">
                <div class="row row-post justify-center"> 
                    ...
                    <?php if (has_post_thumbnail()) : ?>
						...
						<?php endif; ?>
                        <div class="entry-date cl-navy wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"><?php the_time('F j, Y'); ?></div>
                        ...
                        <div class="m-t3">                        
                        <a tabindex="0" class="simple-link link-navy wow fadeInUp"  data-wow-duration="0.8s" data-wow-delay="0.5s" href="/news" aria-label="BACK TO NEWS" title="BACK TO NEWS">
                        BACK TO NEWS                            
                         </a>                        
                      </div>                                             
                    </div>                   
