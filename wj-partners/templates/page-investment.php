<?php
/**
 * The template for displaying investment page
...
<?php }else {
 ...
 get_template_part('template-parts/sections/section-banner-media-full');
 get_template_part('template-parts/sections/section-info-columns'); 
