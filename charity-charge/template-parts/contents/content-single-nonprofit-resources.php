	...
	<section class="content-info-section pt-5">
		<div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <header class="post-header mb-4" data-aos="fade-in">
                        ...
                        <div class="post-meta d-flex align-items-center gap-3 mt-lg-5 mt-4">
							<?php 
							$terms = get_the_terms(get_the_ID(), 'nonprofit-resource-category');
                    ...
                    <?php if(get_field("replace_featured_image")){ ?>
                        <?php if(get_field("main_image")): ?>
                            <div class="featured-image-container position-relative" data-aos="fade-in">
                                <div class="featured-image-wrapper">
                                    <img src="<?php echo esc_url(get_field("main_image")["url"]); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" class="featured-image-post img-fluid">
                                </div>
                            </div>
                        <?php endif; ?>
                    <?php }else{ ?>    
                    ...
                    <div class="social-share mt-4 justify-content-md-betwen">
                        <?php if (has_post_thumbnail()) : ?>
                            ...
                            $custom_caption = get_field('featured_image_caption'); // ACF field for custom caption
                            
                            // Use custom caption if available, otherwise use default caption
                            $final_caption = $custom_caption ? $custom_caption : $caption;
            ...
            <div class="row row-content g-lg-5">
                <div class="col-lg-8">
                    <?php if(get_field("podcast_frame_code")): ?>
                        <div class="podcast-embed w-100 pb-3">
                            <?php echo get_field("podcast_frame_code"); ?>
                        </div>
                    <?php endif; ?>
                    <!-- Post Content -->
