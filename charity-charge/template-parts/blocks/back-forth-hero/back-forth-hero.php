<?php
$content_block = get_field('back_forth_hero');
if ($content_block) {
        ...
        <div class="<?php echo esc_attr($column_one_size); ?>">
           ...
           <?php if($add_listen_on): ?>
            ...
            <?php if($listen_on_button): ?>
                 <div class="d-flex flex-column flex-md-row flex-wrap gap-3 gap-lg-4 mt-4 <?php echo ($alignment_hori == 'middle') ? 'justify-content-center' : 'justify-content-start'; ?>" data-aos="fade-up" data-aos-delay="50">
                <?php 
           ...
           <div class="container">
            <?php if ( $hero_bottom_style === 'style_1'){ ?>
                <div class="row w-100 d-flex flex-column flex-lg-row justify-content-between align-items-center pb-lg-0 pb-2">
                    <div class="col-12">
                        <div class="top-line-style-1 w-100 mb-lg-3 mb-4"></div>
