<?php
$content_block = get_field('back_forth_info');
if ($content_block) {
...
<section class="back-forth-info-section position-relative <?php echo esc_attr($bg_section_class); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?> <?php echo esc_attr($className); ?>" <?php echo $anchor_attr; ?>>
   <div class="top-section">
    <div class="container">
        <?php if ($main_heading) : ?>
           <div class="row">
               <div class="col-12 text-lg-center mb-lg-4">
                   <h2 class="color-black mb-lg-5 mb-3" data-aos="fade-up">
           ...
           <?php endif; ?> 
            ...
            <div class="list-items-into mt-4">               
                        ...
                        <div class="mb-3 mb-md-4" data-aos="fade-up" data-aos-delay="<?php echo 50 + ($i * 50); ?>">
                            <div class="list-item">
                                <?php if ($item_icon): ?>
                                    <img class="icon-item" src="<?php echo esc_url($item_icon['url']); ?>" alt="<?php echo esc_attr($item_icon['alt']); ?>">
                                <?php endif; ?>
