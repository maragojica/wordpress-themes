<?php
$content_block = get_field('platforms_grid_content');
if ($content_block) {
    
    $heading = $content_block['heading'];   
    $description = $content_block['description'];   
    $logos_list = $content_block['logos_platform_list'];     
...
<section class="platforms-grid-section position-relative <?php echo esc_attr($bg_section_class); ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
    <div class="container">
       <div class="<?php echo esc_attr($container_classes); ?> mb-lg-5">
       ...
       <?php if($logos_list): ?>
         <div class="row justify-content-start g-4 mt-2 mt-lg-5">
            <?php $i = 1; foreach ($logos_list as $logo) : 
                $image = $logo['image'];
                 $link = $logo['link']; ?>
                 <div class="col-12 col-sm-6 col-md-6 col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="<?php echo 10 + ($i * 50); ?>">
                    <div class="logo-box w-100 h-100">
                        <?php if ($link) : ?>
