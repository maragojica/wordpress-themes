<?php
$content_block = get_field('cards_icons_styletwo_info');
if ($content_block) {
...
<section class="card-icons-style-two-section position-relative <?php echo esc_attr($bg_section_class); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?> <?php echo esc_attr($className); ?>" <?php echo $anchor_attr; ?>>
  <div class="container">
        ...
        <?php endif; ?>       
           <?php if ($add_list_items) : 
            if($list_items): ?>
            <div class="row row-cards-icons g-3 row-style-icons-two justify-content-center">               
                        <?php $i = 1; foreach ($list_items as $item): 
                            $item_icon = $item['item_icon']; 
                            $item_title = $item['item_title'];
                            $item_text = $item['item_text']; ?>                       
                        <div class="<?php echo esc_attr($columns_class); ?> d-flex" data-aos="fade-in">
                            <div class="icon-card-list w-100 h-100 flex flex-column justify-content-center">
                                <?php if ($item_icon): ?>
                                ...
                                <div class="card-icon-header">                                        
                                    ...
                                    <?php endif; ?>
                                    <?php if($item_text): ?>
                                        <div class="card-icon-description color-neutral">
                                            <?php echo $item_text; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
