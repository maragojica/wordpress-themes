<?php
$content_block = get_field('resources_slider_content');
if ($content_block) {
...
<section class="resources-slider-section position-relative <?php echo esc_attr($bg_section_class); ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
    <?php if (!$settings) { ?>  
    <div class="container">
   ...
   <?php } else { 
            include get_template_directory() . '/template-parts/global/global-resources-slider.php'; 
        } ?>    
</section> 
<?php }
?>
