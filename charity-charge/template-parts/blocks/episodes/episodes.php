<?php
$content_block = get_field('episodes');
if ($content_block) {
    
    $heading = $content_block['heading'];   
    $description = $content_block['description'];   
    $episodes_code = $content_block['episodes_code'];     
...
<section class="episodes-section position-relative <?php echo esc_attr($bg_section_class); ?> <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>
    <div class="container">
       ...
       <?php if($episodes_code): ?>
         <div class="box-episodes_code mt-3" data-aos="fade-in">
            <?php echo $episodes_code; ?>
         </div>   
       <?php endif; ?>  
       <?php if ($buttons) : ?>
        <div class="<?php echo esc_attr($container_classes); ?>">
