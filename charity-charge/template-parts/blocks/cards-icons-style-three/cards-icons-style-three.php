<?php
$content_block = get_field('cards_icons_stylethree_info');
if ($content_block) {
...
<section class="card-icons-style-three-section position-relative <?php echo esc_attr($bg_section_class); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?> <?php echo esc_attr($className); ?>" <?php echo $anchor_attr; ?>>
  <div class="container">
        <?php if ($subheading || $heading || $description) : ?>
           <div class="<?php echo esc_attr($container_classes); ?> ">
               <div class="col-12 col-lg-6">
                    ...
                    <?php endif; ?>  
                     <?php if($description): ?>                   
                        <div class="<?php echo esc_attr($text_color_class); ?> main-description" data-aos="fade-up" data-aos-delay="50">
           ...
           <?php if ($add_list_items) : 
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 col-xl-9">
                    <div class="row row-cards-icons row-cards-icons-three g-4 justify-content-center">               
                        <?php $i = 1; foreach ($list_items as $item): 
                            $item_icon = $item['item_icon']; 
                            $item_title = $item['item_title'];
                            $item_text = $item['item_text']; ?>                       
                        <div class="<?php echo esc_attr($columns_class); ?> d-flex" data-aos="fade-in">
                            <div class="icon-card-list w-100 h-100 flex flex-column justify-content-center bg-blue-darker">
                                <?php if ($item_icon): ?>
                                    <img class="icon-card" src="<?php echo esc_url($item_icon['url']); ?>" alt="<?php echo esc_attr($item_icon['alt']); ?>">
                                <?php endif; ?>
                                <div class="card-icon-header">                                        
                                    <?php if($item_title): ?>
                                        <div class="card-icon-title color-white"><?php echo esc_html($item_title); ?></div>
                                    <?php endif; ?>
                                    <?php if($item_text): ?>
                                        <div class="card-icon-description color-white">
                                            <?php echo $item_text; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
