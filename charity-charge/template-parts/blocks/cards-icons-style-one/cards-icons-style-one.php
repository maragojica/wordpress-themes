<?php
$content_block = get_field('cards_icons_styleone_info');
if ($content_block) {
...
<section class="card-icons-style-one-section position-relative <?php echo esc_attr($bg_section_class); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?> <?php echo esc_attr($className); ?>" <?php echo $anchor_attr; ?>>
  <div class="container">
        ...
        <?php endif; ?>       
           <?php if ($add_list_items) : 
            if($list_items): ?>
            <div class="row row-cards-icons row-style-icon-one g-4 justify-content-center">               
                        ...
                        <div class="<?php echo esc_attr($columns_class); ?> d-flex" data-aos="fade-in">
                            <div class="icon-card-list w-100 h-100 flex flex-column justify-content-center bg-white">
                                ...
                                <div class="card-icon-header">                                        
                                    ...
                                    <?php endif; ?>
                                    <?php if($item_text): ?>
                                        <div class="card-icon-description color-foreground-medium">
                                            <?php echo $item_text; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
