<?php
$content_block = get_field('tools_grid_content');
if ($content_block) {
       ...
       <?php if($logos_list): ?>
        <div class="row justify-content-center mt-lg-3">
            ...
            <?php $i = 1; foreach ($logos_list as $logo) : 
                $image = $logo['image'];
                 $link = $logo['link']; ?>
                 <div class="col-12 col-sm-6 col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="<?php echo 10 + ($i * 50); ?>">
                    <div class="logo-box logo-tool w-100 h-100">
                        <?php if ($link) : ?>
