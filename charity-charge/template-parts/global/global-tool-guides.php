<?php
$content_block = get_field('tool_guides_content_global', 'option');
if ($content_block) {
               ...
               <?php if ($subheading) : ?> 
                ...
                <div class="<?php echo esc_attr($container_classes); ?>">
                    <div class="col-12 text-center">
                        <div class="d-flex flex-column flex-lg-row flex-wrap gap-3 mt-3 justify-content-start justify-content-lg-center" data-aos="fade-up" data-aos-delay="50">
        ...
        <?php if($tool_guides): ?>
            <div class="row row-tool-guides mt-3 mt-lg-5" data-aos="fade-in">
                <?php foreach ($tool_guides as $tool_guide) : 
                   ...
                   $use_custom_author = get_field('use_custom_author', $tool_guide_id);
                ...
                <div class="col-lg-4 mb-lg-0 mb-4">
                    <div class="featured-card d-flex flex-column h-100">
                        <div class="featured-image">
                            <a href="<?php echo esc_url($tool_guide_link); ?>" tabindex="0" aria-label="<?php echo esc_html($tool_guide_title); ?>" title="<?php echo esc_html($tool_guide_title); ?>" class="w-100 h-100">
                        ...
                        <div class="featured-content d-flex flex-column flex-grow-1">
                            ...
                            <div class="featured-title">
                                <a href="<?php echo esc_url($tool_guide_link); ?>"><?php echo esc_html($tool_guide_title); ?></a>
                            </div>
