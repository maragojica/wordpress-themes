<?php
$content_block = get_field('content_block_contain');
if ($content_block) {
    ...
    $iframe_code = $content_block['iframe_code']; 
    ...
    switch ($columns_gap) {
        ...
        case 'large':
         ...
         case 'xlarge':
            if ($reverse_desktop) {
                $columns_gap_class = ' lg:pl-[70px] xl:pl-[100px] lg:pr-0';
            } else {
                $columns_gap_class = ' lg:pr-[70px] xl:pr-[100px] lg:pl-0';
            }
            break;
        default:   
            if ($reverse_desktop) {
...
<section class="back-forth-contain-section max-w-full relative overflow-hidden <?php if($bg_color): echo $bg_class; endif; ?>  <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?>>   
    ...
    <?php } ?> 
        <div class="container mx-auto relative z-2">        
          <div class="<?php echo esc_attr($container_classes); ?> lg:gap-y-0 gap-y-[3em]">               
              <div class="<?php echo esc_attr($heading_width); ?> custom-p-info <?php echo $row_gap_class; ?> <?php echo $columns_gap_class; ?>  justify-center">
                    <?php if($subheading): ?>
                    ...
                    <?php endif;  endif; ?>                     
                        <?php if($description): ?>
                        <div class="text-foreground style-disc mt-[20px] xl:mt-[34px]" data-aos="fade-in" >                 
               ...
               <div class="<?php echo esc_attr($content_width); ?>" <?php if($reverse_desktop){ ?> data-aos="fade-left" <?php }else{ ?> data-aos="fade-right" <?php } ?>  >  
                    <div class="media-box w-full lg:min-h-[23em] lg:h-full md:h-[25em] sm:h-[20em] h-[15em] relative bg-cover bg-top bg-no-repeat" <?php if($media_type['value'] == "image"){ ?> style="background-image: url('<?php echo esc_url($image['url']); ?>');" <?php } ?>>
                        <?php if($media_type['value'] == "video"){   ?>   
                                ...
                                <?php if($video_type['value'] == "file"){  ?>   
                                    ...
                                    <?php } ?>  
                            <?php }elseif($media_type['value'] == "iframe"){ ?>    
