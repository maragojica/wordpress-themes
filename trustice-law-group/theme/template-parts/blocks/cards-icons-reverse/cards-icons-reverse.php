<?php
$content_block = get_field('content_block_cards_icons_reverse');
if ($content_block) {   
...
<section class="cards-icons-section max-w-full h-auto relative overflow-hidden bg-accent-light <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?>>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-<?php echo $num_cols; ?> <?php echo esc_attr($gap_class); ?> mt-[46px]">
                 <?php $i = 0; foreach ($info_list as $column): 
                    ...
                    <div class="relative" data-aos="fade-up" data-aos-delay="<?= $i * 100 ?>">  
                      <div class="h-full flex flex-col justify-between bg-white shadow-cards px-[20px] lg:px-[60px] pt-[25px] lg:pt-[50px] pb-[50px] items-start text-left relative">
                         <div class="flex-grow">
                        <?php if ($icon) :
                          $icon_url = $icon['url'];
                            $icon_alt = $icon['alt']; ?>    
                            <div class="w-[55px] h-[55px] lg:w-[70px] lg:h-[70px] flex items-start justify-start mb-[20px]">                         
