<?php
$content_block = get_field('content_block_resources');
if ($content_block) {   
...
<section class="resources-section max-w-full h-auto relative overflow-hidden <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?>>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-<?php echo $num_cols; ?> <?php echo esc_attr($gap_class); ?> mt-[46px]">
                 <?php $i = 0; foreach ($info_list as $column): 
                    ...
                    <div class="relative" data-aos="fade-up" data-aos-delay="<?= $i * 100 ?>">  
                      <div class="h-full flex flex-col justify-between bg-accent-light shadow-cards px-[20px] lg:px-[26px] pt-[25px] lg:pt-[37px] pb-[25px] lg:pb-[39px] items-start text-left relative">
                         <div class="flex-grow">
                        <?php if ($icon) :
                          $icon_url = $icon['url'];
                            $icon_alt = $icon['alt']; ?>    
                        ...
                        <?php endif; ?>                                 
                        <?php if ($title) : ?>
                            <h5 class="text-primary mt-[20px] mb-0">
                                <?php echo $title; ?>
                            </h5>
                        <?php endif; ?>
                        <?php if ($text) : ?>
                        ...
                        <?php if ($buttons) : ?>                                
                        <div class="flex flex-col w-full flex-wrap gap-2 lg:gap-8 mt-[20px] lg:mt-[27px] justify-center">
