...
<section class="faqs-section max-w-full relative overflow-hidden <?php if($bg_color): echo $bg_class; endif; ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?> <?php echo esc_attr($className); ?> " <?php echo $anchor_attr; ?>> 
          ...
          <div class="<?php echo esc_attr($heading_width); ?> ">  
             ...
             <?php if($subheading): ?>
                ...
                <?php if ($heading) : ?>
                    ...
                    <?php endif; ?>  
                     <?php if ($questions) : ?>
                    <div class="w-full overflow-hidden mt-[20px] lg:mt-[34px]">
                        <?php foreach ($questions as $index => $question) : ?>
                            <div class="full-border mt-[10px] bg-accent-light shadow-cards" data-aos="fade-in">
                                <button id="controlsAccordionItem<?php echo esc_attr($index); ?>" type="button" class="text-secondary cursor-pointer accordion-header flex w-full items-center justify-between gap-4 text-left p-[20px] lg:px-[40px] lg:py-[25px] focus-visible:outline-none" aria-controls="accordionItem<?php echo esc_attr($index); ?>" aria-expanded="<?php echo $index === 0 ? 'true' : 'false'; ?>">
                                    <div class="faq-header my-0 text-primary w-fit"><?php echo esc_html($question['title']); ?></div>                           
                                ...
                                <div id="accordionItem<?php echo esc_attr($index); ?>" class="accordion-content overflow-hidden transition-max-height duration-300 ease-out <?php echo $index === 0 ? 'max-h-screen' : 'max-h-0'; ?>" role="region" aria-labelledby="controlsAccordionItem<?php echo esc_attr($index); ?>">
                                    <div class="style-disc text-foreground pb-[20px] px-[20px] lg:px-[40px]">
