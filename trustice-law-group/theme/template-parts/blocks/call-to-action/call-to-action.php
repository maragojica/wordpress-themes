...
<section class="call-to-action-section bg-primary max-w-full w-full relative overflow-hidden">
 ...
 <div class="w-full h-full <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>">
    <div class="container mx-auto">        
          <div class="w-full mx-auto <?php echo esc_attr($container_classes); ?> relative lg:gap-y-0 gap-y-[1em]">  
                ...
                <?php endif; ?> 
                    <?php if ($heading) : ?>
                    <h3 class="text-white heading-shape mb-0" >
                        <?php echo $heading; ?>
                    </h3> 
                <?php endif; ?>  
                <?php if($description): ?>
                        <div class="text-white text-large style-disc mt-[15px]" data-aos="fade-in" data-aos-delay="100" >                 
