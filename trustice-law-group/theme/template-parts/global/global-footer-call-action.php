<?php
$content_block = get_field('content_block_global_call_to_action', 'option');
if ($content_block) {   
    ...
    $container_classes = ' flex flex-col items-center  ';   
...
<div <?php if($section_id) echo 'id="' . esc_attr($section_id) . '"'; ?> class="call-to-action-footer max-w-full w-full relative overflow-hidden <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>">
<div class=" max-w-full w-full relative overflow-hidden ">  
    <div class="container mx-auto">        
          <div class="w-full mx-auto <?php echo esc_attr($container_classes); ?> relative text-center"> 
                <?php if($subheading): ?>
                ...
                <?php endif; ?>  
                <?php if($description): ?>
                        <div class="text-white text-large style-disc mt-[20px]" data-aos="fade-up" data-aos-delay="100" >                 
                            <?php echo $description; ?>                   
                        </div>
                    <?php endif; ?>                 
               <?php if ($buttons) : ?>
                        <div class="flex flex-wrap gap-2 lg:gap-[16px] justify-center mt-[18px]" data-aos="fade-up">
