<?php
/**
 * Template part for displaying single team member content
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<section class="entry-content-single max-w-full relative bg-accent-light overflow-hidden relative z-[1] pt-[119px] xl:pt-[190px]">
	<div class="w-full h-full padding-large">
		<div class="w-full lg:hidden block">
			<div class="container mx-auto">
				<h2 class="text-tertiary mb-0 lg:hidden block">
				<?php the_title(); ?>
			</h2> 
			<?php if($position): ?>
				<div class="eyebrow text-foreground mt-[10px] lg:hidden block" data-aos="fade-in" >
					<?php echo $position; ?>
				</div>   
			<?php endif; ?> 
			</div>
				...
				<div class="max-w-full lg:max-w-[90%] 2xl:max-w-[80%] mx-auto">
					<div class="flex flex-col lg:flex-row items-start justify-center gap-y-[2em] lg:gap-y-0 lg:gap-x-[60px]">
						<div class="w-full lg:w-1/2 xl:w-1/4">								
							...
							<div class="w-full h-fit lg:h-[330px] 2xl:h-[412px] team-box lg:mt-0 mt-[30px] relative overflow-hidden">
						...
						<div class="w-full lg:w-1/2 xl:w-3/4">
							<h2 class="text-tertiary mb-0 lg:block hidden">
								<?php the_title(); ?>
							</h2> 
							<?php if($position): ?>
								<div class="eyebrow text-foreground mt-[10px] lg:block hidden" data-aos="fade-in" >
									<?php echo $position; ?>
								</div>   
							<?php endif; ?>  
							<div class="w-full h-[4px] bg-secondary mt-[30px] lg:block hidden"></div>
							<?php if($bio): ?>
								<div class="text-large text-foreground style-disc lg:mt-[30px]" data-aos="fade-in" data-aos-delay="100" >                 
									<?php echo $bio; ?>                   
								</div>
							<?php endif; ?> 
