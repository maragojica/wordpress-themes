...
?>
<div class="single-content pt-[119px] xl:pt-[190px]">
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
<section class="content-section max-w-full relative bg-accent-light  padding-large"> 
		...
		<div class="flex flex-col ">
			<div class="w-full"> 
				...
				// get first post category for this post, excluding category with slug or name "all"
				$categories = get_the_category( get_the_ID() );
				$term_label = '';

				if ( ! empty( $categories ) ) {
					foreach ( $categories as $cat ) {
						if ( strtolower( $cat->slug ) === 'all' || strtolower( $cat->name ) === 'all' ) {
							continue;
						}
						$term_label = $cat->name;
						break;
				...
				?>
				<div class="eyebrow text-foreground mb-[20px]">
					<?php if ( $display_date ) : ?>
