...
<section class="logos-list-section max-w-full relative <?php echo esc_attr($className); ?> <?php echo esc_attr($spacing_class); ?> <?php echo esc_attr($spacing_responsive_class); ?>" <?php echo $anchor_attr; ?> <?php if($bg_color):?> style="background-color: <?php echo $bg_color;?>" <?php endif; ?>>  
     <div class="container mx-auto">  
        ...
        <?php if ($heading) : ?>
            <h2 class="text-secondary mb-3 xl:mb-5 animate__animated" data-animation="fadeIn" data-duration="1.3s">
                <?php echo $heading; ?>
            </h2>
        <?php endif; ?> 
        </div> 
                ...
                <?php if(!empty($logo)): ?>
                    <?php  if($link) {
                        ...
                        <?php  echo wp_get_attachment_image(
                            ...
                            false,
                            array(
                                'class' => 'transition-all duration-300 w-full h-[60px] object-contain transition-transform',
